...
RSpec.describe Fontist::Indexes::DefaultFamilyFontIndex do
  describe "#from_yaml" do
    context "round-trips" do
      filename = 'spec/fixtures/default_family_font_index/formula_index.default_family.yml'
      it "#{filename}" do
  ...
  describe "#load_formulas" do
    let(:filename) { 'spec/fixtures/default_family_font_index/formula_index.default_family.yml' }

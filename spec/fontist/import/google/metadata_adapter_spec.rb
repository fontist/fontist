...
RSpec.describe Fontist::Import::Google::MetadataAdapter do
  describe ".adapt" do
    context "with simple font (ABeeZee)" do
      let(:file_path) { "/Users/mulgogi/src/external/google-fonts/ofl/abeezee/METADATA.pb" }
    ...
    context "with variable font (Alexandria)" do
      let(:file_path) { "/Users/mulgogi/src/external/google-fonts/ofl/alexandria/METADATA.pb" }
      let(:unibuf_message) { Unibuf.parse_textproto_file(file_path) }
      let(:metadata) { described_class.adapt(unibuf_message) }
    ...
    context "with complex variable font (Roboto Flex)" do
      let(:file_path) { "/Users/mulgogi/src/external/google-fonts/ofl/robotoflex/METADATA.pb" }
      let(:unibuf_message) { Unibuf.parse_textproto_file(file_path) }
      let(:metadata) { described_class.adapt(unibuf_message) }
    ...
    context "with large file (Noto Sans)" do
      let(:file_path) { "/Users/mulgogi/src/external/google-fonts/ofl/notosans/METADATA.pb" }
      let(:unibuf_message) { Unibuf.parse_textproto_file(file_path) }
      let(:metadata) { described_class.adapt(unibuf_message) }

  ...
  module Import
    module Otf
      class FontFile
        ...
        STYLE_ATTRIBUTES = %i[family_name type default_family_name default_type
                              full_name post_script_name
        ...
        def default_family_name
          info["Family"] if info["Family"] != family_name
        end

        def default_type
          info["Subfamily"] if info["Subfamily"] != type
        end

module Fontist
  module Formulas
    class GoudyBookletter1911Font < FontFormula
      FULLNAME = "Goudy Bookletter 1911".freeze
      CLEANNAME = "GoudyBookletter1911".freeze

      desc FULLNAME
      homepage "http://sortsmill.googlecode.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Goudy%20Bookletter%201911"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/GoudyBookletter1911.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/GoudyBookletter1911.ttf", :exist?
        end
      end

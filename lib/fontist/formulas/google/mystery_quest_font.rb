module Fontist
  module Formulas
    class MysteryQuestFont < FontFormula
      FULLNAME = "Mystery Quest".freeze
      CLEANNAME = "MysteryQuest".freeze

      desc FULLNAME
      homepage "http://www.fontbros.com/sideshow.php"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Mystery%20Quest"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/MysteryQuest-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/MysteryQuest-Regular.ttf", :exist?
        end
      end

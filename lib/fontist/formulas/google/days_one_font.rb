module Fontist
  module Formulas
    class DaysOneFont < FontFormula
      FULLNAME = "Days One".freeze
      CLEANNAME = "DaysOne".freeze

      desc FULLNAME
      homepage "http://jovanny.ru/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Days%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/DaysOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/DaysOne-Regular.ttf", :exist?
        end
      end

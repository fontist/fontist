module Fontist
  module Formulas
    class AdventProFont < FontFormula
      FULLNAME = "Advent Pro".freeze
      CLEANNAME = "AdventPro".freeze

      desc FULLNAME
      homepage "www.inderesting.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Advent%20Pro"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/AdventPro-Thin.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/AdventPro-Thin.ttf", :exist?
        end
      end

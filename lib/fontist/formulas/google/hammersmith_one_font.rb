module Fontist
  module Formulas
    class HammersmithOneFont < FontFormula
      FULLNAME = "Hammersmith One".freeze
      CLEANNAME = "HammersmithOne".freeze

      desc FULLNAME
      homepage "sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Hammersmith%20One"
...
http://scripts.sil.org/OFL",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/HammersmithOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/HammersmithOne-Regular.ttf", :exist?
        end
      end

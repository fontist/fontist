module Fontist
  module Formulas
    class NokoraFont < FontFormula
      FULLNAME = "Nokora".freeze
      CLEANNAME = "Nokora".freeze

      desc FULLNAME
      homepage "http://khmertype.blogspot.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Nokora"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Nokora-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Nokora-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class PirataOneFont < FontFormula
      FULLNAME = "Pirata One".freeze
      CLEANNAME = "PirataOne".freeze

      desc FULLNAME
      homepage "abc.taip.com.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Pirata%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PirataOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PirataOne-Regular.ttf", :exist?
        end
      end

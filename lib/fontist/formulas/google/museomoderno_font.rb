module Fontist
  module Formulas
    class MuseoModernoFont < FontFormula
      FULLNAME = "MuseoModerno".freeze
      CLEANNAME = "MuseoModerno".freeze

      desc FULLNAME
      homepage "https://www.omnibus-type.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=MuseoModerno"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/MuseoModerno[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/MuseoModerno[wght].ttf", :exist?
        end
      end

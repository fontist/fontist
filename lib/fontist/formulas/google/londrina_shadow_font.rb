module Fontist
  module Formulas
    class LondrinaShadowFont < FontFormula
      FULLNAME = "Londrina Shadow".freeze
      CLEANNAME = "LondrinaShadow".freeze

      desc FULLNAME
      homepage "http://www.tipospereira.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Londrina%20Shadow"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/LondrinaShadow-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/LondrinaShadow-Regular.ttf", :exist?
        end
      end

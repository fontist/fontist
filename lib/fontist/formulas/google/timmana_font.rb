module Fontist
  module Formulas
    class TimmanaFont < FontFormula
      FULLNAME = "Timmana".freeze
      CLEANNAME = "Timmana".freeze

      desc FULLNAME
      homepage "adityafonts.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Timmana"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Timmana-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Timmana-Regular.ttf", :exist?
        end
      end

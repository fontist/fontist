module Fontist
  module Formulas
    class SimonettaFont < FontFormula
      FULLNAME = "Simonetta".freeze
      CLEANNAME = "Simonetta".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Simonetta"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Simonetta-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Simonetta-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class ScheherazadeFont < FontFormula
      FULLNAME = "Scheherazade".freeze
      CLEANNAME = "Scheherazade".freeze

      desc FULLNAME
      homepage "http://www.sil.org/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Scheherazade"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Scheherazade-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Scheherazade-Regular.ttf", :exist?
        end
      end

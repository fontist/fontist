module Fontist
  module Formulas
    class UnnaFont < FontFormula
      FULLNAME = "Unna".freeze
      CLEANNAME = "Unna".freeze

      desc FULLNAME
      homepage "http://www.omnibus-type.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Unna"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Unna-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Unna-Regular.ttf", :exist?
        end
      end

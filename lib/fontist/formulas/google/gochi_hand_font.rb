module Fontist
  module Formulas
    class GochiHandFont < FontFormula
      FULLNAME = "Gochi Hand".freeze
      CLEANNAME = "GochiHand".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Gochi%20Hand"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/GochiHand-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/GochiHand-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class MeddonFont < FontFormula
      FULLNAME = "Meddon".freeze
      CLEANNAME = "Meddon".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Meddon"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Meddon.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Meddon.ttf", :exist?
        end
      end

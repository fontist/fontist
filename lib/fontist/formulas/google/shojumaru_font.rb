module Fontist
  module Formulas
    class ShojumaruFont < FontFormula
      FULLNAME = "Shojumaru".freeze
      CLEANNAME = "Shojumaru".freeze

      desc FULLNAME
      homepage "http://www.astigmatic.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Shojumaru"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Shojumaru-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Shojumaru-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        ...
        (astigma@astigmatic.com), with Reserved Font Names "Shojumaru"

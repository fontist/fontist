module Fontist
  module Formulas
    class FlamencoFont < FontFormula
      FULLNAME = "Flamenco".freeze
      CLEANNAME = "Flamenco".freeze

      desc FULLNAME
      homepage "www.latinotype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Flamenco"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Flamenco-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Flamenco-Light.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        ...
        with Reserved Font Names "Flamenco"

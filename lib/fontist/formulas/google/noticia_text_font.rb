module Fontist
  module Formulas
    class NoticiaTextFont < FontFormula
      FULLNAME = "Noticia Text".freeze
      CLEANNAME = "NoticiaText".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Noticia%20Text"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/NoticiaText-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/NoticiaText-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class PalanquinFont < FontFormula
      FULLNAME = "Palanquin".freeze
      CLEANNAME = "Palanquin".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Palanquin"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Palanquin-Thin.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Palanquin-Thin.ttf", :exist?
        end
      end

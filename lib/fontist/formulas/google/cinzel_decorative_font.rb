module Fontist
  module Formulas
    class CinzelDecorativeFont < FontFormula
      FULLNAME = "Cinzel Decorative".freeze
      CLEANNAME = "CinzelDecorative".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Cinzel%20Decorative"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/CinzelDecorative-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/CinzelDecorative-Regular.ttf", :exist?
        end
      end

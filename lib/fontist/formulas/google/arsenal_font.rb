module Fontist
  module Formulas
    class ArsenalFont < FontFormula
      FULLNAME = "Arsenal".freeze
      CLEANNAME = "Arsenal".freeze

      desc FULLNAME
      homepage "http://stairsfor.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Arsenal"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Arsenal-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Arsenal-Regular.ttf", :exist?
        end
      end

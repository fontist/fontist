module Fontist
  module Formulas
    class UnderdogFont < FontFormula
      FULLNAME = "Underdog".freeze
      CLEANNAME = "Underdog".freeze

      desc FULLNAME
      homepage "http://www.jovanny.ru"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Underdog"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Underdog-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Underdog-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class AlmendraFont < FontFormula
      FULLNAME = "Almendra".freeze
      CLEANNAME = "Almendra".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Almendra"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Almendra-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Almendra-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class CormorantUnicaseFont < FontFormula
      FULLNAME = "Cormorant Unicase".freeze
      CLEANNAME = "CormorantUnicase".freeze

      desc FULLNAME
      homepage "https://github.com/CatharsisFonts"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Cormorant%20Unicase"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/CormorantUnicase-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/CormorantUnicase-Light.ttf", :exist?
        end
      end

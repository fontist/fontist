module Fontist
  module Formulas
    class RevaliaFont < FontFormula
      FULLNAME = "Revalia".freeze
      CLEANNAME = "Revalia".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Revalia"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Revalia-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Revalia-Regular.ttf", :exist?
        end
      end

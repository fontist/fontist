module Fontist
  module Formulas
    class NanumGothicFont < FontFormula
      FULLNAME = "Nanum Gothic".freeze
      CLEANNAME = "NanumGothic".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/NanumGothic-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/NanumGothic-Regular.ttf", :exist?
        end
      end

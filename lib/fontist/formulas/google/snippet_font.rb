module Fontist
  module Formulas
    class SnippetFont < FontFormula
      FULLNAME = "Snippet".freeze
      CLEANNAME = "Snippet".freeze

      desc FULLNAME
      homepage "http://www.gesine-todt.de"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Snippet"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Snippet.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Snippet.ttf", :exist?
        end
      end

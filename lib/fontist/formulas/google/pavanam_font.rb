module Fontist
  module Formulas
    class PavanamFont < FontFormula
      FULLNAME = "Pavanam".freeze
      CLEANNAME = "Pavanam".freeze

      desc FULLNAME
      homepage "http://niram.org"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Pavanam"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Pavanam-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Pavanam-Regular.ttf", :exist?
        end
      end

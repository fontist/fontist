module Fontist
  module Formulas
    class ChangaOneFont < FontFormula
      FULLNAME = "Changa One".freeze
      CLEANNAME = "ChangaOne".freeze

      desc FULLNAME
      homepage "http://www.tipo.net.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Changa%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ChangaOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ChangaOne-Regular.ttf", :exist?
        end
      end

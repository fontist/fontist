module Fontist
  module Formulas
    class CagliostroFont < FontFormula
      FULLNAME = "Cagliostro".freeze
      CLEANNAME = "Cagliostro".freeze

      desc FULLNAME
      homepage "http://www.madtype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Cagliostro"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Cagliostro-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Cagliostro-Regular.ttf", :exist?
        end
      end

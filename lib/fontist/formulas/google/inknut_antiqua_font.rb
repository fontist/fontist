module Fontist
  module Formulas
    class InknutAntiquaFont < FontFormula
      FULLNAME = "Inknut Antiqua".freeze
      CLEANNAME = "InknutAntiqua".freeze

      desc FULLNAME
      homepage "http://www.forthehearts.net"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Inknut%20Antiqua"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/InknutAntiqua-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/InknutAntiqua-Light.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class GothicA1Font < FontFormula
      FULLNAME = "Gothic A1".freeze
      CLEANNAME = "GothicA1".freeze

      desc FULLNAME
      homepage "http://www.hanyang.co.kr"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Gothic%20A1"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/GothicA1-Thin.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/GothicA1-Thin.ttf", :exist?
        end
      end

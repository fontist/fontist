module Fontist
  module Formulas
    class VastShadowFont < FontFormula
      FULLNAME = "Vast Shadow".freeze
      CLEANNAME = "VastShadow".freeze

      desc FULLNAME
      homepage "sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Vast%20Shadow"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/VastShadow-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/VastShadow-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        ...
        with Reserved Font Names "Vast" and "Vast Shadow".

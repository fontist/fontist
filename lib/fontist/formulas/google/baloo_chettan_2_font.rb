module Fontist
  module Formulas
    class BalooChettan2Font < FontFormula
      FULLNAME = "Baloo Chettan 2".freeze
      CLEANNAME = "BalooChettan2".freeze

      desc FULLNAME
      homepage "www.ektype.in"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Baloo%20Chettan%202"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/BalooChettan2-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/BalooChettan2-Regular.ttf", :exist?
        end
      end

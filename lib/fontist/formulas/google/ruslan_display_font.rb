module Fontist
  module Formulas
    class RuslanDisplayFont < FontFormula
      FULLNAME = "Ruslan Display".freeze
      CLEANNAME = "RuslanDisplay".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ruslan%20Display"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/RuslanDisplay.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/RuslanDisplay.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class RussoOneFont < FontFormula
      FULLNAME = "Russo One".freeze
      CLEANNAME = "RussoOne".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Russo%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/RussoOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/RussoOne-Regular.ttf", :exist?
        end
      end

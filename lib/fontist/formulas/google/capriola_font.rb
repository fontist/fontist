module Fontist
  module Formulas
    class CapriolaFont < FontFormula
      FULLNAME = "Capriola".freeze
      CLEANNAME = "Capriola".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Capriola"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Capriola-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Capriola-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        Copyright (c) 2012 by Sorkin Type Co (www.sorkintype.com), with Reserved Font Name "Capriola".

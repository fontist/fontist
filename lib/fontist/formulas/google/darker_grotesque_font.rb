module Fontist
  module Formulas
    class DarkerGrotesqueFont < FontFormula
      FULLNAME = "Darker Grotesque".freeze
      CLEANNAME = "DarkerGrotesque".freeze

      desc FULLNAME
      homepage "bygabriel.co"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Darker%20Grotesque"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/DarkerGrotesque-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/DarkerGrotesque-Light.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        Copyright 2019, Gabriel Lam, TypeRant.

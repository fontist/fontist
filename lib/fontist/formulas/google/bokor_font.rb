module Fontist
  module Formulas
    class BokorFont < FontFormula
      FULLNAME = "Bokor".freeze
      CLEANNAME = "Bokor".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Bokor"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Bokor-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Bokor-Regular.ttf", :exist?
        end
      end

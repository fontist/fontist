module Fontist
  module Formulas
    class GlegooFont < FontFormula
      FULLNAME = "Glegoo".freeze
      CLEANNAME = "Glegoo".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Glegoo"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Glegoo-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Glegoo-Regular.ttf", :exist?
        end
      end

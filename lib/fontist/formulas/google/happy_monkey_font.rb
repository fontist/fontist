module Fontist
  module Formulas
    class HappyMonkeyFont < FontFormula
      FULLNAME = "Happy Monkey".freeze
      CLEANNAME = "HappyMonkey".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Happy%20Monkey"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/HappyMonkey-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/HappyMonkey-Regular.ttf", :exist?
        end
      end

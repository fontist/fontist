module Fontist
  module Formulas
    class InriaSerifFont < FontFormula
      FULLNAME = "Inria Serif".freeze
      CLEANNAME = "InriaSerif".freeze

      desc FULLNAME
      homepage "http://www.black-foundry.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Inria%20Serif"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/InriaSerif-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/InriaSerif-Light.ttf", :exist?
        end
      end

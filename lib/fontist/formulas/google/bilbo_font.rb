module Fontist
  module Formulas
    class BilboFont < FontFormula
      FULLNAME = "Bilbo".freeze
      CLEANNAME = "Bilbo".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Bilbo"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Bilbo-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Bilbo-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class MartelFont < FontFormula
      FULLNAME = "Martel".freeze
      CLEANNAME = "Martel".freeze

      desc FULLNAME
      homepage "http://www.typeoff.de"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Martel"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Martel-UltraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Martel-UltraLight.ttf", :exist?
        end
      end

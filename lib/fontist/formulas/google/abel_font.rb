module Fontist
  module Formulas
    class AbelFont < FontFormula
      FULLNAME = "Abel".freeze
      CLEANNAME = "Abel".freeze

      desc FULLNAME
      homepage "http://www.madtype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Abel"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Abel-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Abel-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class OrbitronFont < FontFormula
      FULLNAME = "Orbitron".freeze
      CLEANNAME = "Orbitron".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Orbitron[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Orbitron[wght].ttf", :exist?
        end
      end

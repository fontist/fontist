module Fontist
  module Formulas
    class RamabhadraFont < FontFormula
      FULLNAME = "Ramabhadra".freeze
      CLEANNAME = "Ramabhadra".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ramabhadra"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Ramabhadra-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Ramabhadra-Regular.ttf", :exist?
        end
      end

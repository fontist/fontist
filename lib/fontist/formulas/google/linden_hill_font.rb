module Fontist
  module Formulas
    class LindenHillFont < FontFormula
      FULLNAME = "Linden Hill".freeze
      CLEANNAME = "LindenHill".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Linden%20Hill"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/LindenHill-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/LindenHill-Regular.ttf", :exist?
        end
      end

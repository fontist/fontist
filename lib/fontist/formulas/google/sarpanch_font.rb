module Fontist
  module Formulas
    class SarpanchFont < FontFormula
      FULLNAME = "Sarpanch".freeze
      CLEANNAME = "Sarpanch".freeze

      desc FULLNAME
      homepage "http://www.indiantypefoundry.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Sarpanch"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Sarpanch-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Sarpanch-Regular.ttf", :exist?
        end
      end

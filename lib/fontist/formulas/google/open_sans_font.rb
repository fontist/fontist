module Fontist
  module Formulas
    class OpenSansFont < FontFormula
      FULLNAME = "Open Sans".freeze
      CLEANNAME = "OpenSans".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/OpenSans-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/OpenSans-Light.ttf", :exist?
        end
      end

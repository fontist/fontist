module Fontist
  module Formulas
    class AmikoFont < FontFormula
      FULLNAME = "Amiko".freeze
      CLEANNAME = "Amiko".freeze

      desc FULLNAME
      homepage "http://www.impallari.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Amiko"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Amiko-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Amiko-Regular.ttf", :exist?
        end
      end

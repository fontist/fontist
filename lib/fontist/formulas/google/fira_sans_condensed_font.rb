  ...
  module Formulas
    class FiraSansCondensedFont < FontFormula
      ...
      provides_font(FULLNAME, match_styles_from_file: {
        "Thin" => "FiraSansCondensed-Thin.ttf",
        "ThinItalic" => "FiraSansCondensed-ThinItalic.ttf",
        "ExtraLight" => "FiraSansCondensed-ExtraLight.ttf",
        "ExtraLightItalic" => "FiraSansCondensed-ExtraLightItalic.ttf",
        "Light" => "FiraSansCondensed-Light.ttf",
        "LightItalic" => "FiraSansCondensed-LightItalic.ttf",
        "Regular" => "FiraSansCondensed-Regular.ttf",
        "Italic" => "FiraSansCondensed-Italic.ttf",
        "Medium" => "FiraSansCondensed-Medium.ttf",
        "MediumItalic" => "FiraSansCondensed-MediumItalic.ttf",
        "SemiBold" => "FiraSansCondensed-SemiBold.ttf",
        "SemiBoldItalic" => "FiraSansCondensed-SemiBoldItalic.ttf",
        "Bold" => "FiraSansCondensed-Bold.ttf",
        "BoldItalic" => "FiraSansCondensed-BoldItalic.ttf",
        "ExtraBold" => "FiraSansCondensed-ExtraBold.ttf",
        "ExtraBoldItalic" => "FiraSansCondensed-ExtraBoldItalic.ttf",
        "Black" => "FiraSansCondensed-Black.ttf",
        "BlackItalic" => "FiraSansCondensed-BlackItalic.ttf",
      })

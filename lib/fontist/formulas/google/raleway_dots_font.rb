module Fontist
  module Formulas
    class RalewayDotsFont < FontFormula
      FULLNAME = "Raleway Dots".freeze
      CLEANNAME = "RalewayDots".freeze

      desc FULLNAME
      homepage "http://theleagueofmoveabletype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Raleway%20Dots"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/RalewayDots-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/RalewayDots-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        Copyright (c) 2010, Matt McInerney (matt@pixelspread.com), Copyright (c) 2012, Pablo Impallari (www.impallari.com|impallari@gmail.com), Copyright (c) 2012, Brenda Gallo. (gbrenda1987@gmail.com), Copyright (c) 2012, Rodrigo Fuenzalida (www.rfuenzalida.com|hello@rfuenzalida.com), with Reserved Font Name "Raleway"

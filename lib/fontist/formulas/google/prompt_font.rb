  ...
  module Formulas
    class PromptFont < FontFormula
      ...
      provides_font(FULLNAME, match_styles_from_file: {
        "Thin" => "Prompt-Thin.ttf",
        "ThinItalic" => "Prompt-ThinItalic.ttf",
        "ExtraLight" => "Prompt-ExtraLight.ttf",
        "ExtraLightItalic" => "Prompt-ExtraLightItalic.ttf",
        "Light" => "Prompt-Light.ttf",
        "LightItalic" => "Prompt-LightItalic.ttf",
        "Regular" => "Prompt-Regular.ttf",
        "Italic" => "Prompt-Italic.ttf",
        "Medium" => "Prompt-Medium.ttf",
        "MediumItalic" => "Prompt-MediumItalic.ttf",
        "SemiBold" => "Prompt-SemiBold.ttf",
        "SemiBoldItalic" => "Prompt-SemiBoldItalic.ttf",
        "Bold" => "Prompt-Bold.ttf",
        "BoldItalic" => "Prompt-BoldItalic.ttf",
        "ExtraBold" => "Prompt-ExtraBold.ttf",
        "ExtraBoldItalic" => "Prompt-ExtraBoldItalic.ttf",
        "Black" => "Prompt-Black.ttf",
        "BlackItalic" => "Prompt-BlackItalic.ttf",
      })

module Fontist
  module Formulas
    class CamboFont < FontFormula
      FULLNAME = "Cambo".freeze
      CLEANNAME = "Cambo".freeze

      desc FULLNAME
      homepage "http://www.huertatipografica.com.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Cambo"
...
with Reserved Font Name Cambo.",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Cambo-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Cambo-Regular.ttf", :exist?
        end
      end

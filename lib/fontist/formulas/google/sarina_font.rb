module Fontist
  module Formulas
    class SarinaFont < FontFormula
      FULLNAME = "Sarina".freeze
      CLEANNAME = "Sarina".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Sarina"
...
with Reserved Font Name \"Sarina\".",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Sarina-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Sarina-Regular.ttf", :exist?
        end
      end

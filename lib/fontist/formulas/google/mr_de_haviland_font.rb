module Fontist
  module Formulas
    class MrDeHavilandFont < FontFormula
      FULLNAME = "Mr De Haviland".freeze
      CLEANNAME = "MrDeHaviland".freeze

      desc FULLNAME
      homepage "http://www.sudtipos.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Mr%20De%20Haviland"
...
with Reserved Font Name \"Mr De Haviland\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/MrDeHaviland-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/MrDeHaviland-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class GentiumBookBasicFont < FontFormula
      FULLNAME = "Gentium Book Basic".freeze
      CLEANNAME = "GentiumBookBasic".freeze

      desc FULLNAME
      homepage "http://scripts.sil.org/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Gentium%20Book%20Basic"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/GenBkBasR.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/GenBkBasR.ttf", :exist?
        end
      end

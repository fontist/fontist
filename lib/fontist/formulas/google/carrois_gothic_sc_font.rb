module Fontist
  module Formulas
    class CarroisGothicSCFont < FontFormula
      FULLNAME = "Carrois Gothic SC".freeze
      CLEANNAME = "CarroisGothicSC".freeze

      desc FULLNAME
      homepage "http://www.carrois.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Carrois%20Gothic%20SC"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/CarroisGothicSC-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/CarroisGothicSC-Regular.ttf", :exist?
        end
      end

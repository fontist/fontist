module Fontist
  module Formulas
    class AlfaSlabOneFont < FontFormula
      FULLNAME = "Alfa Slab One".freeze
      CLEANNAME = "AlfaSlabOne".freeze

      desc FULLNAME
      homepage "http://www.jmsole.cl"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Alfa%20Slab%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/AlfaSlabOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/AlfaSlabOne-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class DiplomataSCFont < FontFormula
      FULLNAME = "Diplomata SC".freeze
      CLEANNAME = "DiplomataSC".freeze

      desc FULLNAME
      homepage "http://www.tipo.net.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Diplomata%20SC"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/DiplomataSC-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/DiplomataSC-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class ExoFont < FontFormula
      FULLNAME = "Exo".freeze
      CLEANNAME = "Exo".freeze

      desc FULLNAME
      homepage "http://www.ndiscovered.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Exo"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Exo[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Exo[wght].ttf", :exist?
        end
      end

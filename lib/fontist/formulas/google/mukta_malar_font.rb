module Fontist
  module Formulas
    class MuktaMalarFont < FontFormula
      FULLNAME = "Mukta Malar".freeze
      CLEANNAME = "MuktaMalar".freeze

      desc FULLNAME
      homepage "www.ektype.in"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Mukta%20Malar"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/MuktaMalar-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/MuktaMalar-ExtraLight.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class BuenardFont < FontFormula
      FULLNAME = "Buenard".freeze
      CLEANNAME = "Buenard".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Buenard"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Buenard-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Buenard-Regular.ttf", :exist?
        end
      end

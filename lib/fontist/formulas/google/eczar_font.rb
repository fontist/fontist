module Fontist
  module Formulas
    class EczarFont < FontFormula
      FULLNAME = "Eczar".freeze
      CLEANNAME = "Eczar".freeze

      desc FULLNAME
      homepage "http://rosettatype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Eczar"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Eczar-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Eczar-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class B612Font < FontFormula
      FULLNAME = "B612".freeze
      CLEANNAME = "B612".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=B612"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/B612-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/B612-Regular.ttf", :exist?
        end
      end

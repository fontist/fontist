  ...
  module Formulas
    class KrubFont < FontFormula
      ...
      provides_font(FULLNAME, match_styles_from_file: {
        "ExtraLight" => "Krub-ExtraLight.ttf",
        "ExtraLightItalic" => "Krub-ExtraLightItalic.ttf",
        "Light" => "Krub-Light.ttf",
        "LightItalic" => "Krub-LightItalic.ttf",
        "Regular" => "Krub-Regular.ttf",
        "Italic" => "Krub-Italic.ttf",
        "Medium" => "Krub-Medium.ttf",
        "MediumItalic" => "Krub-MediumItalic.ttf",
        "SemiBold" => "Krub-SemiBold.ttf",
        "SemiBoldItalic" => "Krub-SemiBoldItalic.ttf",
        "Bold" => "Krub-Bold.ttf",
        "BoldItalic" => "Krub-BoldItalic.ttf",
      })

module Fontist
  module Formulas
    class MuktaFont < FontFormula
      FULLNAME = "Mukta".freeze
      CLEANNAME = "Mukta".freeze

      desc FULLNAME
      homepage "www.ektype.in"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Mukta"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Mukta-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Mukta-ExtraLight.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class RadleyFont < FontFormula
      FULLNAME = "Radley".freeze
      CLEANNAME = "Radley".freeze

      desc FULLNAME
      homepage "http://www.sansoxygen.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Radley"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Radley-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Radley-Regular.ttf", :exist?
        end
      end

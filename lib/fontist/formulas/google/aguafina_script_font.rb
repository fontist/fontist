module Fontist
  module Formulas
    class AguafinaScriptFont < FontFormula
      FULLNAME = "Aguafina Script".freeze
      CLEANNAME = "AguafinaScript".freeze

      desc FULLNAME
      homepage "http://www.sudtipos.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Aguafina%20Script"
...
with Reserved Font Name \"Aguafina Script\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/AguafinaScript-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/AguafinaScript-Regular.ttf", :exist?
        end
      end

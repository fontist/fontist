module Fontist
  module Formulas
    class BalsamiqSansFont < FontFormula
      FULLNAME = "Balsamiq Sans".freeze
      CLEANNAME = "BalsamiqSans".freeze

      desc FULLNAME
      homepage "http://balsamiq.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Balsamiq%20Sans"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/BalsamiqSans-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/BalsamiqSans-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class MoulpaliFont < FontFormula
      FULLNAME = "Moulpali".freeze
      CLEANNAME = "Moulpali".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Moulpali"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Moulpali.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Moulpali.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        ...
        with Reserved Font Name Moulpali.

module Fontist
  module Formulas
    class MarckScriptFont < FontFormula
      FULLNAME = "Marck Script".freeze
      CLEANNAME = "MarckScript".freeze

      desc FULLNAME
      homepage "denis.masharov@gmail.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Marck%20Script"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/MarckScript-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/MarckScript-Regular.ttf", :exist?
        end
      end

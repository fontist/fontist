module Fontist
  module Formulas
    class MonotonFont < FontFormula
      FULLNAME = "Monoton".freeze
      CLEANNAME = "Monoton".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Monoton"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Monoton-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Monoton-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class UltraFont < FontFormula
      FULLNAME = "Ultra".freeze
      CLEANNAME = "Ultra".freeze

      desc FULLNAME
      homepage "http://www.astigmatic.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ultra"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Ultra-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Ultra-Regular.ttf", :exist?
        end
      end

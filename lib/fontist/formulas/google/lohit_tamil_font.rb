module Fontist
  module Formulas
    class LohitTamilFont < FontFormula
      FULLNAME = "Lohit Tamil".freeze
      CLEANNAME = "LohitTamil".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Lohit%20Tamil"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Lohit-Tamil.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Lohit-Tamil.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class CorbenFont < FontFormula
      FULLNAME = "Corben".freeze
      CLEANNAME = "Corben".freeze

      desc FULLNAME
      homepage "newtypography.co.uk"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Corben"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Corben-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Corben-Regular.ttf", :exist?
        end
      end

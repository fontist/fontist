module Fontist
  module Formulas
    class LailaFont < FontFormula
      FULLNAME = "Laila".freeze
      CLEANNAME = "Laila".freeze

      desc FULLNAME
      homepage "http://www.indiantypefoundry.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Laila"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Laila-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Laila-Light.ttf", :exist?
        end
      end

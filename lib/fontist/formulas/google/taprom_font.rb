module Fontist
  module Formulas
    class TapromFont < FontFormula
      FULLNAME = "Taprom".freeze
      CLEANNAME = "Taprom".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Taprom"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Taprom.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Taprom.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        ...
        with Reserved Font Name Taprom.

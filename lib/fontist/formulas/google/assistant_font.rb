module Fontist
  module Formulas
    class AssistantFont < FontFormula
      FULLNAME = "Assistant".freeze
      CLEANNAME = "Assistant".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Assistant"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Assistant-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Assistant-ExtraLight.ttf", :exist?
        end
      end

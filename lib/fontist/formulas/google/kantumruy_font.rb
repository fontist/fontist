module Fontist
  module Formulas
    class KantumruyFont < FontFormula
      FULLNAME = "Kantumruy".freeze
      CLEANNAME = "Kantumruy".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Kantumruy"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Kantumruy-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Kantumruy-Light.ttf", :exist?
        end
      end

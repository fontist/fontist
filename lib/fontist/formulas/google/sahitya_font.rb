module Fontist
  module Formulas
    class SahityaFont < FontFormula
      FULLNAME = "Sahitya".freeze
      CLEANNAME = "Sahitya".freeze

      desc FULLNAME
      homepage "http://www.huertatipografica.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Sahitya"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Sahitya-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Sahitya-Regular.ttf", :exist?
        end
      end

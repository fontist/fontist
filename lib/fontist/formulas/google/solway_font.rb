module Fontist
  module Formulas
    class SolwayFont < FontFormula
      FULLNAME = "Solway".freeze
      CLEANNAME = "Solway".freeze

      desc FULLNAME
      homepage "http://www.thenorthernblock.co.uk"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Solway"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Solway-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Solway-Light.ttf", :exist?
        end
      end

  ...
  module Formulas
    class AlegreyaSansSCFont < FontFormula
      ...
      provides_font(FULLNAME, match_styles_from_file: {
        "Thin" => "AlegreyaSansSC-Thin.ttf",
        "ThinItalic" => "AlegreyaSansSC-ThinItalic.ttf",
        "Light" => "AlegreyaSansSC-Light.ttf",
        "LightItalic" => "AlegreyaSansSC-LightItalic.ttf",
        "Regular" => "AlegreyaSansSC-Regular.ttf",
        "Italic" => "AlegreyaSansSC-Italic.ttf",
        "Medium" => "AlegreyaSansSC-Medium.ttf",
        "MediumItalic" => "AlegreyaSansSC-MediumItalic.ttf",
        "Bold" => "AlegreyaSansSC-Bold.ttf",
        "BoldItalic" => "AlegreyaSansSC-BoldItalic.ttf",
        "ExtraBold" => "AlegreyaSansSC-ExtraBold.ttf",
        "ExtraBoldItalic" => "AlegreyaSansSC-ExtraBoldItalic.ttf",
        "Black" => "AlegreyaSansSC-Black.ttf",
        "BlackItalic" => "AlegreyaSansSC-BlackItalic.ttf",
      })

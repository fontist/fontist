module Fontist
  module Formulas
    class RochesterFont < FontFormula
      FULLNAME = "Rochester".freeze
      CLEANNAME = "Rochester".freeze

      desc FULLNAME
      homepage "http://www.fontbros.com/sideshow.php"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Rochester"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Rochester-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Rochester-Regular.ttf", :exist?
        end
      end

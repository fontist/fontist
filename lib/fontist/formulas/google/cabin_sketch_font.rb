module Fontist
  module Formulas
    class CabinSketchFont < FontFormula
      FULLNAME = "Cabin Sketch".freeze
      CLEANNAME = "CabinSketch".freeze

      desc FULLNAME
      homepage "http://www.impallari.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Cabin%20Sketch"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/CabinSketch-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/CabinSketch-Regular.ttf", :exist?
        end
      end

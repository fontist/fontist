module Fontist
  module Formulas
    class ArimaMaduraiFont < FontFormula
      FULLNAME = "Arima Madurai".freeze
      CLEANNAME = "ArimaMadurai".freeze

      desc FULLNAME
      homepage "www.ndiscover.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Arima%20Madurai"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ArimaMadurai-Thin.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ArimaMadurai-Thin.ttf", :exist?
        end
      end

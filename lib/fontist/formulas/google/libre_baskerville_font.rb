module Fontist
  module Formulas
    class LibreBaskervilleFont < FontFormula
      FULLNAME = "Libre Baskerville".freeze
      CLEANNAME = "LibreBaskerville".freeze

      desc FULLNAME
      homepage "www.impallari.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Libre%20Baskerville"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/LibreBaskerville-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/LibreBaskerville-Regular.ttf", :exist?
        end
      end

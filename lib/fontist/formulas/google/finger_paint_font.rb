module Fontist
  module Formulas
    class FingerPaintFont < FontFormula
      FULLNAME = "Finger Paint".freeze
      CLEANNAME = "FingerPaint".freeze

      desc FULLNAME
      homepage "http://www.carrois.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Finger%20Paint"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/FingerPaint-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/FingerPaint-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class RobotoMonoFont < FontFormula
      FULLNAME = "Roboto Mono".freeze
      CLEANNAME = "RobotoMono".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/RobotoMono[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/RobotoMono[wght].ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class StalinistOneFont < FontFormula
      FULLNAME = "Stalinist One".freeze
      CLEANNAME = "StalinistOne".freeze

      desc FULLNAME
      homepage "http://jovanny.ru"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Stalinist%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/StalinistOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/StalinistOne-Regular.ttf", :exist?
        end
      end

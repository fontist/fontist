module Fontist
  module Formulas
    class ScopeOneFont < FontFormula
      FULLNAME = "Scope One".freeze
      CLEANNAME = "ScopeOne".freeze

      desc FULLNAME
      homepage "http://www.daltonmaag.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Scope%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ScopeOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ScopeOne-Regular.ttf", :exist?
        end
      end

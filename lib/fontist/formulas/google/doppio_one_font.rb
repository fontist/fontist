module Fontist
  module Formulas
    class DoppioOneFont < FontFormula
      FULLNAME = "Doppio One".freeze
      CLEANNAME = "DoppioOne".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Doppio%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/DoppioOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/DoppioOne-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class ModakFont < FontFormula
      FULLNAME = "Modak".freeze
      CLEANNAME = "Modak".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Modak"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Modak-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Modak-Regular.ttf", :exist?
        end
      end

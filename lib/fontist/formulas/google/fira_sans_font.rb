  ...
  module Formulas
    class FiraSansFont < FontFormula
      ...
      provides_font(FULLNAME, match_styles_from_file: {
        ...
        "ThinItalic" => "FiraSans-ThinItalic.ttf",
        "ExtraLight" => "FiraSans-ExtraLight.ttf",
        "ExtraLightItalic" => "FiraSans-ExtraLightItalic.ttf",
        "Light" => "FiraSans-Light.ttf",
        "LightItalic" => "FiraSans-LightItalic.ttf",
        "Regular" => "FiraSans-Regular.ttf",
        "Italic" => "FiraSans-Italic.ttf",
        "Medium" => "FiraSans-Medium.ttf",
        "MediumItalic" => "FiraSans-MediumItalic.ttf",
        "SemiBold" => "FiraSans-SemiBold.ttf",
        "SemiBoldItalic" => "FiraSans-SemiBoldItalic.ttf",
        "Bold" => "FiraSans-Bold.ttf",
        "BoldItalic" => "FiraSans-BoldItalic.ttf",
        "ExtraBold" => "FiraSans-ExtraBold.ttf",
        "ExtraBoldItalic" => "FiraSans-ExtraBoldItalic.ttf",
        "Black" => "FiraSans-Black.ttf",
        "BlackItalic" => "FiraSans-BlackItalic.ttf",
      })

module Fontist
  module Formulas
    class BitterFont < FontFormula
      FULLNAME = "Bitter".freeze
      CLEANNAME = "Bitter".freeze

      desc FULLNAME
      homepage "https://www.solmatas.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Bitter"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Bitter[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Bitter[wght].ttf", :exist?
        end
      end

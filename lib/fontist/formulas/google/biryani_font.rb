module Fontist
  module Formulas
    class BiryaniFont < FontFormula
      FULLNAME = "Biryani".freeze
      CLEANNAME = "Biryani".freeze

      desc FULLNAME
      homepage "http://www.typeoff.de"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Biryani"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Biryani-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Biryani-ExtraLight.ttf", :exist?
        end
      end

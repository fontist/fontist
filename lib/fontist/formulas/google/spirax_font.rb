module Fontist
  module Formulas
    class SpiraxFont < FontFormula
      FULLNAME = "Spirax".freeze
      CLEANNAME = "Spirax".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Spirax"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Spirax-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Spirax-Regular.ttf", :exist?
        end
      end

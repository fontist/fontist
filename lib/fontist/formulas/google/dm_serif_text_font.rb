module Fontist
  module Formulas
    class DMSerifTextFont < FontFormula
      FULLNAME = "DM Serif Text".freeze
      CLEANNAME = "DMSerifText".freeze

      desc FULLNAME
      homepage "http://www.colophon-foundry.org"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=DM%20Serif%20Text"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/DMSerifText-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/DMSerifText-Regular.ttf", :exist?
        end
      end

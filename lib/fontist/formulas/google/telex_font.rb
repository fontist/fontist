module Fontist
  module Formulas
    class TelexFont < FontFormula
      FULLNAME = "Telex".freeze
      CLEANNAME = "Telex".freeze

      desc FULLNAME
      homepage "http://www.huertatipografica.com.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Telex"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Telex-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Telex-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class AmethystaFont < FontFormula
      FULLNAME = "Amethysta".freeze
      CLEANNAME = "Amethysta".freeze

      desc FULLNAME
      homepage "http://cyreal.org"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Amethysta"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Amethysta-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Amethysta-Regular.ttf", :exist?
        end
      end

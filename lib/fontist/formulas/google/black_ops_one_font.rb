module Fontist
  module Formulas
    class BlackOpsOneFont < FontFormula
      FULLNAME = "Black Ops One".freeze
      CLEANNAME = "BlackOpsOne".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Black%20Ops%20One"
...
with Reserved Font Names \"Black Ops\" and \"Black Ops One\".",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/BlackOpsOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/BlackOpsOne-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class VampiroOneFont < FontFormula
      FULLNAME = "Vampiro One".freeze
      CLEANNAME = "VampiroOne".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Vampiro%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/VampiroOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/VampiroOne-Regular.ttf", :exist?
        end
      end

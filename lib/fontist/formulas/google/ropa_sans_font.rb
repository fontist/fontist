module Fontist
  module Formulas
    class RopaSansFont < FontFormula
      FULLNAME = "Ropa Sans".freeze
      CLEANNAME = "RopaSans".freeze

      desc FULLNAME
      homepage "http://www.lettersoup.de"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ropa%20Sans"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/RopaSans-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/RopaSans-Regular.ttf", :exist?
        end
      end

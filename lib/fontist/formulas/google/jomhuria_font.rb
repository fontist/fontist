module Fontist
  module Formulas
    class JomhuriaFont < FontFormula
      FULLNAME = "Jomhuria".freeze
      CLEANNAME = "Jomhuria".freeze

      desc FULLNAME
      homepage "https://github.com/Tarobish/Jomhuria"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Jomhuria"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Jomhuria-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Jomhuria-Regular.ttf", :exist?
        end
      end

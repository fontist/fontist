module Fontist
  module Formulas
    class SairaCondensedFont < FontFormula
      FULLNAME = "Saira Condensed".freeze
      CLEANNAME = "SairaCondensed".freeze

      desc FULLNAME
      homepage "http://www.omnibus-type.com/fonts/chivo.php"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Saira%20Condensed"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/SairaCondensed-Thin.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/SairaCondensed-Thin.ttf", :exist?
        end
      end

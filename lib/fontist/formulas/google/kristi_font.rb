module Fontist
  module Formulas
    class KristiFont < FontFormula
      FULLNAME = "Kristi".freeze
      CLEANNAME = "Kristi".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Kristi"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Kristi-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Kristi-Regular.ttf", :exist?
        end
      end

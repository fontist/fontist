module Fontist
  module Formulas
    class LovedbytheKingFont < FontFormula
      FULLNAME = "Loved by the King".freeze
      CLEANNAME = "LovedbytheKing".freeze

      desc FULLNAME
      homepage "http://kimberlygeswein.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Loved%20by%20the%20King"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/LovedbytheKing.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/LovedbytheKing.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class FederantFont < FontFormula
      FULLNAME = "Federant".freeze
      CLEANNAME = "Federant".freeze

      desc FULLNAME
      homepage "http://cyreal.org"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Federant"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Federant-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Federant-Regular.ttf", :exist?
        end
      end

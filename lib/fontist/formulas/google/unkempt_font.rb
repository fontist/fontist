module Fontist
  module Formulas
    class UnkemptFont < FontFormula
      FULLNAME = "Unkempt".freeze
      CLEANNAME = "Unkempt".freeze

      desc FULLNAME
      homepage "http://www.fontbros.com/sideshow.php"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Unkempt"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Unkempt-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Unkempt-Regular.ttf", :exist?
        end
      end

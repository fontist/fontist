module Fontist
  module Formulas
    class OvoFont < FontFormula
      FULLNAME = "Ovo".freeze
      CLEANNAME = "Ovo".freeze

      desc FULLNAME
      homepage "sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ovo"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Ovo-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Ovo-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class LexendExaFont < FontFormula
      FULLNAME = "Lexend Exa".freeze
      CLEANNAME = "LexendExa".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Lexend%20Exa"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/LexendExa-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/LexendExa-Regular.ttf", :exist?
        end
      end

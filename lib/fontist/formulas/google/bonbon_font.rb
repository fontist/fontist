module Fontist
  module Formulas
    class BonbonFont < FontFormula
      FULLNAME = "Bonbon".freeze
      CLEANNAME = "Bonbon".freeze

      desc FULLNAME
      homepage "http://cyreal.org"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Bonbon"
...
http://scripts.sil.org/OFL",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Bonbon-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Bonbon-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class AsapFont < FontFormula
      FULLNAME = "Asap".freeze
      CLEANNAME = "Asap".freeze

      desc FULLNAME
      homepage "http://www.omnibus-type.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Asap"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Asap-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Asap-Regular.ttf", :exist?
        end
      end

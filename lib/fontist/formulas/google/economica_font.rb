module Fontist
  module Formulas
    class EconomicaFont < FontFormula
      FULLNAME = "Economica".freeze
      CLEANNAME = "Economica".freeze

      desc FULLNAME
      homepage "www.tipotype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Economica"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Economica-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Economica-Regular.ttf", :exist?
        end
      end

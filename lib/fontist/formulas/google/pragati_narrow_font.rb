module Fontist
  module Formulas
    class PragatiNarrowFont < FontFormula
      FULLNAME = "Pragati Narrow".freeze
      CLEANNAME = "PragatiNarrow".freeze

      desc FULLNAME
      homepage "http://www.omnibus-type.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Pragati%20Narrow"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PragatiNarrow-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PragatiNarrow-Regular.ttf", :exist?
        end
      end

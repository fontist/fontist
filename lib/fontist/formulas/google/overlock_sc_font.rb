module Fontist
  module Formulas
    class OverlockSCFont < FontFormula
      FULLNAME = "Overlock SC".freeze
      CLEANNAME = "OverlockSC".freeze

      desc FULLNAME
      homepage "www.tipo.net.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Overlock%20SC"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/OverlockSC-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/OverlockSC-Regular.ttf", :exist?
        end
      end

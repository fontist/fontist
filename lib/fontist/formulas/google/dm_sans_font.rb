module Fontist
  module Formulas
    class DMSansFont < FontFormula
      FULLNAME = "DM Sans".freeze
      CLEANNAME = "DMSans".freeze

      desc FULLNAME
      homepage "http://www.colophon-foundry.org"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=DM%20Sans"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/DMSans-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/DMSans-Regular.ttf", :exist?
        end
      end

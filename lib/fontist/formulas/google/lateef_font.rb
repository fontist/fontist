module Fontist
  module Formulas
    class LateefFont < FontFormula
      FULLNAME = "Lateef".freeze
      CLEANNAME = "Lateef".freeze

      desc FULLNAME
      homepage "http://www.sil.org/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Lateef"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/LateefRegOT.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/LateefRegOT.ttf", :exist?
        end
      end

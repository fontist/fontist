module Fontist
  module Formulas
    class CarmeFont < FontFormula
      FULLNAME = "Carme".freeze
      CLEANNAME = "Carme".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Carme"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Carme-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Carme-Regular.ttf", :exist?
        end
      end

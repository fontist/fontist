module Fontist
  module Formulas
    class CuprumFont < FontFormula
      FULLNAME = "Cuprum".freeze
      CLEANNAME = "Cuprum".freeze

      desc FULLNAME
      homepage "http://jovanny.ru"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Cuprum"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Cuprum-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Cuprum-Regular.ttf", :exist?
        end
      end

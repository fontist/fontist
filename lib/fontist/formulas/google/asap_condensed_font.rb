module Fontist
  module Formulas
    class AsapCondensedFont < FontFormula
      FULLNAME = "Asap Condensed".freeze
      CLEANNAME = "AsapCondensed".freeze

      desc FULLNAME
      homepage "http://www.omnibus-type.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Asap%20Condensed"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/AsapCondensed-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/AsapCondensed-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        Copyright 2018 The Asap Condensed Project Authors (https://github.com/Omnibus-Type/AsapCondensed).

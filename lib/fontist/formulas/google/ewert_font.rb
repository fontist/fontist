module Fontist
  module Formulas
    class EwertFont < FontFormula
      FULLNAME = "Ewert".freeze
      CLEANNAME = "Ewert".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ewert"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Ewert-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Ewert-Regular.ttf", :exist?
        end
      end

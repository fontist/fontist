module Fontist
  module Formulas
    class DMSerifDisplayFont < FontFormula
      FULLNAME = "DM Serif Display".freeze
      CLEANNAME = "DMSerifDisplay".freeze

      desc FULLNAME
      homepage "http://www.colophon-foundry.org"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=DM%20Serif%20Display"
        sha256 "7ccdf5970f0a7b0e6c44677fc51b7e2b04ed97b570388d8936ad2c1f59348284"
      end
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/DMSerifDisplay-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/DMSerifDisplay-Regular.ttf", :exist?
        end
      end

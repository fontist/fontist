module Fontist
  module Formulas
    class CormorantSCFont < FontFormula
      FULLNAME = "Cormorant SC".freeze
      CLEANNAME = "CormorantSC".freeze

      desc FULLNAME
      homepage "https://github.com/CatharsisFonts"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Cormorant%20SC"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/CormorantSC-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/CormorantSC-Light.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class JudsonFont < FontFormula
      FULLNAME = "Judson".freeze
      CLEANNAME = "Judson".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Judson"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Judson-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Judson-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class AmaticSCFont < FontFormula
      FULLNAME = "Amatic SC".freeze
      CLEANNAME = "AmaticSC".freeze

      desc FULLNAME
      homepage "http://www.sansoxygen.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Amatic%20SC"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/AmaticSC-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/AmaticSC-Regular.ttf", :exist?
        end
      end

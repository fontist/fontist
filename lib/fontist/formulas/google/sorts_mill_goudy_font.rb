module Fontist
  module Formulas
    class SortsMillGoudyFont < FontFormula
      FULLNAME = "Sorts Mill Goudy".freeze
      CLEANNAME = "SortsMillGoudy".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Sorts%20Mill%20Goudy"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/SortsMillGoudy-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/SortsMillGoudy-Regular.ttf", :exist?
        end
      end

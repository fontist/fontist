module Fontist
  module Formulas
    class CinzelFont < FontFormula
      FULLNAME = "Cinzel".freeze
      CLEANNAME = "Cinzel".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Cinzel[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Cinzel[wght].ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class CreepsterFont < FontFormula
      FULLNAME = "Creepster".freeze
      CLEANNAME = "Creepster".freeze

      desc FULLNAME
      homepage "http://www.fontdiner.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Creepster"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Creepster-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Creepster-Regular.ttf", :exist?
        end
      end

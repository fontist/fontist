module Fontist
  module Formulas
    class SurannaFont < FontFormula
      FULLNAME = "Suranna".freeze
      CLEANNAME = "Suranna".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Suranna"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Suranna-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Suranna-Regular.ttf", :exist?
        end
      end

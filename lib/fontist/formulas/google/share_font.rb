module Fontist
  module Formulas
    class ShareFont < FontFormula
      FULLNAME = "Share".freeze
      CLEANNAME = "Share".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Share"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Share-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Share-Regular.ttf", :exist?
        end
      end

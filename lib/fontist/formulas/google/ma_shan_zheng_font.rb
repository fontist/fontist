module Fontist
  module Formulas
    class MaShanZhengFont < FontFormula
      FULLNAME = "Ma Shan Zheng".freeze
      CLEANNAME = "MaShanZheng".freeze

      desc FULLNAME
      homepage "http://www.zhongqifont.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ma%20Shan%20Zheng"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/MaShanZheng-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/MaShanZheng-Regular.ttf", :exist?
        end
      end

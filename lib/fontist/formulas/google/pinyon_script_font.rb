module Fontist
  module Formulas
    class PinyonScriptFont < FontFormula
      FULLNAME = "Pinyon Script".freeze
      CLEANNAME = "PinyonScript".freeze

      desc FULLNAME
      homepage "sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Pinyon%20Script"
...
This Font Software is licensed under the SIL Open Font License, Version 1.1. This license is copied below, and is also available with a FAQ at: http://scripts.sil.org/OFL",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PinyonScript-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PinyonScript-Regular.ttf", :exist?
        end
      end

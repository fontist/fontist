module Fontist
  module Formulas
    class KatibehFont < FontFormula
      FULLNAME = "Katibeh".freeze
      CLEANNAME = "Katibeh".freeze

      desc FULLNAME
      homepage "https://github.com/Tarobish/Mirza"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Katibeh"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Katibeh-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Katibeh-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class PalanquinDarkFont < FontFormula
      FULLNAME = "Palanquin Dark".freeze
      CLEANNAME = "PalanquinDark".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Palanquin%20Dark"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PalanquinDark-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PalanquinDark-Regular.ttf", :exist?
        end
      end

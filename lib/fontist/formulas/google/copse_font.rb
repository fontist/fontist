module Fontist
  module Formulas
    class CopseFont < FontFormula
      FULLNAME = "Copse".freeze
      CLEANNAME = "Copse".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Copse"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Copse-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Copse-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class MulishFont < FontFormula
      FULLNAME = "Mulish".freeze
      CLEANNAME = "Mulish".freeze

      desc FULLNAME
      homepage "http://www.sansoxygen.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Mulish"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Mulish[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Mulish[wght].ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class CondimentFont < FontFormula
      FULLNAME = "Condiment".freeze
      CLEANNAME = "Condiment".freeze

      desc FULLNAME
      homepage "www.sudtipos.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Condiment"
...
with Reserved Font Name \"Condiment\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Condiment-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Condiment-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class MerriweatherFont < FontFormula
      FULLNAME = "Merriweather".freeze
      CLEANNAME = "Merriweather".freeze

      desc FULLNAME
      homepage "http://sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Merriweather"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Merriweather-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Merriweather-Light.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class HeptaSlabFont < FontFormula
      FULLNAME = "Hepta Slab".freeze
      CLEANNAME = "HeptaSlab".freeze

      desc FULLNAME
      homepage "https://michaellagattuta.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Hepta%20Slab"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/HeptaSlab[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/HeptaSlab[wght].ttf", :exist?
        end
      end

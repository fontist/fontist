module Fontist
  module Formulas
    class DancingScriptFont < FontFormula
      FULLNAME = "Dancing Script".freeze
      CLEANNAME = "DancingScript".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/DancingScript[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/DancingScript[wght].ttf", :exist?
        end
      end

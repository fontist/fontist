module Fontist
  module Formulas
    class AlluraFont < FontFormula
      FULLNAME = "Allura".freeze
      CLEANNAME = "Allura".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Allura"
...
with Reserved Font Name \"Allura\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Allura-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Allura-Regular.ttf", :exist?
        end
      end

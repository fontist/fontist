module Fontist
  module Formulas
    class JustMeAgainDownHereFont < FontFormula
      FULLNAME = "Just Me Again Down Here".freeze
      CLEANNAME = "JustMeAgainDownHere".freeze

      desc FULLNAME
      homepage "http://kimberlygeswein.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Just%20Me%20Again%20Down%20Here"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/JustMeAgainDownHere.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/JustMeAgainDownHere.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class ArchivoBlackFont < FontFormula
      FULLNAME = "Archivo Black".freeze
      CLEANNAME = "ArchivoBlack".freeze

      desc FULLNAME
      homepage "http://omnibus-type.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Archivo%20Black"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ArchivoBlack-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ArchivoBlack-Regular.ttf", :exist?
        end
      end

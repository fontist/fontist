module Fontist
  module Formulas
    class WendyOneFont < FontFormula
      FULLNAME = "Wendy One".freeze
      CLEANNAME = "WendyOne".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Wendy%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/WendyOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/WendyOne-Regular.ttf", :exist?
        end
      end

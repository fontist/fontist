module Fontist
  module Formulas
    class SpicyRiceFont < FontFormula
      FULLNAME = "Spicy Rice".freeze
      CLEANNAME = "SpicyRice".freeze

      desc FULLNAME
      homepage "http://www.astigmatic.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Spicy%20Rice"
...
Font Name \"Spicy Rice\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/SpicyRice-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/SpicyRice-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        ...
        (astigma@astigmatic.com), with Reserved Font Names "Spicy Rice"

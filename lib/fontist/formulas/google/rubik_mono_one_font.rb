module Fontist
  module Formulas
    class RubikMonoOneFont < FontFormula
      FULLNAME = "Rubik Mono One".freeze
      CLEANNAME = "RubikMonoOne".freeze

      desc FULLNAME
      homepage "http://www.google.com/fonts"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Rubik%20Mono%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/RubikMonoOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/RubikMonoOne-Regular.ttf", :exist?
        end
      end

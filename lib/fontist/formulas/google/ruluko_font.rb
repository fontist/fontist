module Fontist
  module Formulas
    class RulukoFont < FontFormula
      FULLNAME = "Ruluko".freeze
      CLEANNAME = "Ruluko".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ruluko"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Ruluko-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Ruluko-Regular.ttf", :exist?
        end
      end

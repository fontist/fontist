module Fontist
  module Formulas
    class ThasadithFont < FontFormula
      FULLNAME = "Thasadith".freeze
      CLEANNAME = "Thasadith".freeze

      desc FULLNAME
      homepage "http://www.cadsondemak.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Thasadith"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Thasadith-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Thasadith-Regular.ttf", :exist?
        end
      end

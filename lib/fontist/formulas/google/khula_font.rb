module Fontist
  module Formulas
    class KhulaFont < FontFormula
      FULLNAME = "Khula".freeze
      CLEANNAME = "Khula".freeze

      desc FULLNAME
      homepage "http://www.erinmclaughlin.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Khula"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Khula-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Khula-Light.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class MetalManiaFont < FontFormula
      FULLNAME = "Metal Mania".freeze
      CLEANNAME = "MetalMania".freeze

      desc FULLNAME
      homepage "http://www.fontbros.com/openwindow.php"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Metal%20Mania"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/MetalMania-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/MetalMania-Regular.ttf", :exist?
        end
      end

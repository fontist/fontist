module Fontist
  module Formulas
    class ZCOOLQingKeHuangYouFont < FontFormula
      FULLNAME = "ZCOOL QingKe HuangYou".freeze
      CLEANNAME = "ZCOOLQingKeHuangYou".freeze

      desc FULLNAME
      homepage "http://zcool.com.cn"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=ZCOOL%20QingKe%20HuangYou"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ZCOOLQingKeHuangYou-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ZCOOLQingKeHuangYou-Regular.ttf", :exist?
        end
      end

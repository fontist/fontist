module Fontist
  module Formulas
    class LustriaFont < FontFormula
      FULLNAME = "Lustria".freeze
      CLEANNAME = "Lustria".freeze

      desc FULLNAME
      homepage "http://www.madtype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Lustria"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Lustria-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Lustria-Regular.ttf", :exist?
        end
      end

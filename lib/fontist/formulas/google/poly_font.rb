module Fontist
  module Formulas
    class PolyFont < FontFormula
      FULLNAME = "Poly".freeze
      CLEANNAME = "Poly".freeze

      desc FULLNAME
      homepage "http://nsilva.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Poly"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Poly-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Poly-Regular.ttf", :exist?
        end
      end

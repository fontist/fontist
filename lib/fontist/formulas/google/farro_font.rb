module Fontist
  module Formulas
    class FarroFont < FontFormula
      FULLNAME = "Farro".freeze
      CLEANNAME = "Farro".freeze

      desc FULLNAME
      homepage "https://grayscale.com.hk/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Farro"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Farro-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Farro-Light.ttf", :exist?
        end
      end

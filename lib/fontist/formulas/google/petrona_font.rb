module Fontist
  module Formulas
    class PetronaFont < FontFormula
      FULLNAME = "Petrona".freeze
      CLEANNAME = "Petrona".freeze

      desc FULLNAME
      homepage "https://www.glyph.co"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Petrona"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Petrona[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Petrona[wght].ttf", :exist?
        end
      end

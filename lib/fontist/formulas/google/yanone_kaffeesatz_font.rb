module Fontist
  module Formulas
    class YanoneKaffeesatzFont < FontFormula
      FULLNAME = "Yanone Kaffeesatz".freeze
      CLEANNAME = "YanoneKaffeesatz".freeze

      desc FULLNAME
      homepage "http://yanone.de"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Yanone%20Kaffeesatz"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/YanoneKaffeesatz[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/YanoneKaffeesatz[wght].ttf", :exist?
        end
      end

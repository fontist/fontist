module Fontist
  module Formulas
    class ImprimaFont < FontFormula
      FULLNAME = "Imprima".freeze
      CLEANNAME = "Imprima".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Imprima"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Imprima-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Imprima-Regular.ttf", :exist?
        end
      end

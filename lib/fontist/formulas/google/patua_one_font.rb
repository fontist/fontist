module Fontist
  module Formulas
    class PatuaOneFont < FontFormula
      FULLNAME = "Patua One".freeze
      CLEANNAME = "PatuaOne".freeze

      desc FULLNAME
      homepage "www.latinotype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Patua%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PatuaOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PatuaOne-Regular.ttf", :exist?
        end
      end

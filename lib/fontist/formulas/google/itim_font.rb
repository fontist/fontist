module Fontist
  module Formulas
    class ItimFont < FontFormula
      FULLNAME = "Itim".freeze
      CLEANNAME = "Itim".freeze

      desc FULLNAME
      homepage "www.katatrad.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Itim"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Itim-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Itim-Regular.ttf", :exist?
        end
      end

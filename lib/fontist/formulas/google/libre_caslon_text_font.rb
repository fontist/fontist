module Fontist
  module Formulas
    class LibreCaslonTextFont < FontFormula
      FULLNAME = "Libre Caslon Text".freeze
      CLEANNAME = "LibreCaslonText".freeze

      desc FULLNAME
      homepage "https://fonts.google.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Libre%20Caslon%20Text"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/LibreCaslonText[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/LibreCaslonText[wght].ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class HindMaduraiFont < FontFormula
      FULLNAME = "Hind Madurai".freeze
      CLEANNAME = "HindMadurai".freeze

      desc FULLNAME
      homepage "https://github.com/itfoundry/hind-madurai"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Hind%20Madurai"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/HindMadurai-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/HindMadurai-Light.ttf", :exist?
        end
      end

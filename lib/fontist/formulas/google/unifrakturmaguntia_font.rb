module Fontist
  module Formulas
    class UnifrakturMaguntiaFont < FontFormula
      FULLNAME = "UnifrakturMaguntia".freeze
      CLEANNAME = "UnifrakturMaguntia".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=UnifrakturMaguntia"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/UnifrakturMaguntia-Book.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/UnifrakturMaguntia-Book.ttf", :exist?
        end
      end

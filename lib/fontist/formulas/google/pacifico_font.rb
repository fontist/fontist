module Fontist
  module Formulas
    class PacificoFont < FontFormula
      FULLNAME = "Pacifico".freeze
      CLEANNAME = "Pacifico".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Pacifico-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Pacifico-Regular.ttf", :exist?
        end
      end

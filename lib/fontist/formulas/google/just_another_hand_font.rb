module Fontist
  module Formulas
    class JustAnotherHandFont < FontFormula
      FULLNAME = "Just Another Hand".freeze
      CLEANNAME = "JustAnotherHand".freeze

      desc FULLNAME
      homepage "http://www.astigmatic.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Just%20Another%20Hand"
...
http://www.apache.org/licenses/LICENSE-2.0.html",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/JustAnotherHand-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/JustAnotherHand-Regular.ttf", :exist?
        end
      end

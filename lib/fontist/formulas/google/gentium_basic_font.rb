module Fontist
  module Formulas
    class GentiumBasicFont < FontFormula
      FULLNAME = "Gentium Basic".freeze
      CLEANNAME = "GentiumBasic".freeze

      desc FULLNAME
      homepage "http://scripts.sil.org/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Gentium%20Basic"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/GenBasR.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/GenBasR.ttf", :exist?
        end
      end

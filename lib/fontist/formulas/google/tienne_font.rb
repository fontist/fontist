module Fontist
  module Formulas
    class TienneFont < FontFormula
      FULLNAME = "Tienne".freeze
      CLEANNAME = "Tienne".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Tienne"
...
http://scripts.sil.org/OFL",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Tienne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Tienne-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        ...
        Copyright (c) 2009, 2010, 2011 Google, Inc (www.google.com/webfonts),
        with Reserved Font Names "Artifika", "Tienne"

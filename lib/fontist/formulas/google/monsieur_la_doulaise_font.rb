module Fontist
  module Formulas
    class MonsieurLaDoulaiseFont < FontFormula
      FULLNAME = "Monsieur La Doulaise".freeze
      CLEANNAME = "MonsieurLaDoulaise".freeze

      desc FULLNAME
      homepage "http://www.sudtipos.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Monsieur%20La%20Doulaise"
...
with Reserved Font Name \"MonsieurLaDoulaise\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/MonsieurLaDoulaise-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/MonsieurLaDoulaise-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        ...
        with Reserved Font Name "Monsieur La Doulaise"

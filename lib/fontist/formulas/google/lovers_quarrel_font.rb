module Fontist
  module Formulas
    class LoversQuarrelFont < FontFormula
      FULLNAME = "Lovers Quarrel".freeze
      CLEANNAME = "LoversQuarrel".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Lovers%20Quarrel"
...
with Reserved Font Name \"Lovers Quarrel\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/LoversQuarrel-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/LoversQuarrel-Regular.ttf", :exist?
        end
      end

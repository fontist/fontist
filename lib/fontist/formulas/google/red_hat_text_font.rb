module Fontist
  module Formulas
    class RedHatTextFont < FontFormula
      FULLNAME = "Red Hat Text".freeze
      CLEANNAME = "RedHatText".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/RedHatText-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/RedHatText-Regular.ttf", :exist?
        end
      end

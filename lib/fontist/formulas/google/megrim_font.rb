module Fontist
  module Formulas
    class MegrimFont < FontFormula
      FULLNAME = "Megrim".freeze
      CLEANNAME = "Megrim".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Megrim"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Megrim.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Megrim.ttf", :exist?
        end
      end

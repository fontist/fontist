module Fontist
  module Formulas
    class AudiowideFont < FontFormula
      FULLNAME = "Audiowide".freeze
      CLEANNAME = "Audiowide".freeze

      desc FULLNAME
      homepage "http://www.astigmatic.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Audiowide"
...
Font Name \"Audiowide\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Audiowide-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Audiowide-Regular.ttf", :exist?
        end
      end

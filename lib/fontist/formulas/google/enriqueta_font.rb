module Fontist
  module Formulas
    class EnriquetaFont < FontFormula
      FULLNAME = "Enriqueta".freeze
      CLEANNAME = "Enriqueta".freeze

      desc FULLNAME
      homepage "http://www.72puntos.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Enriqueta"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Enriqueta-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Enriqueta-Regular.ttf", :exist?
        end
      end

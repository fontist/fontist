module Fontist
  module Formulas
    class JungeFont < FontFormula
      FULLNAME = "Junge".freeze
      CLEANNAME = "Junge".freeze

      desc FULLNAME
      homepage "cyreal.org"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Junge"
...
http://scripts.sil.org/OFL",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Junge-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Junge-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class ComboFont < FontFormula
      FULLNAME = "Combo".freeze
      CLEANNAME = "Combo".freeze

      desc FULLNAME
      homepage "http://www.tipo.net.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Combo"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Combo-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Combo-Regular.ttf", :exist?
        end
      end

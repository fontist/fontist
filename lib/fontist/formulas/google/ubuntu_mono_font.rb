module Fontist
  module Formulas
    class UbuntuMonoFont < FontFormula
      FULLNAME = "Ubuntu Mono".freeze
      CLEANNAME = "UbuntuMono".freeze

      desc FULLNAME
      homepage "http://www.daltonmaag.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ubuntu%20Mono"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/UbuntuMono-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/UbuntuMono-Regular.ttf", :exist?
        end
      end

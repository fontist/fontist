module Fontist
  module Formulas
    class RedHatDisplayFont < FontFormula
      FULLNAME = "Red Hat Display".freeze
      CLEANNAME = "RedHatDisplay".freeze

      desc FULLNAME
      homepage "http://www.mckltype.com"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/RedHatDisplay-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/RedHatDisplay-Regular.ttf", :exist?
        end
      end

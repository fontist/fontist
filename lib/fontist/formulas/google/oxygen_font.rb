module Fontist
  module Formulas
    class OxygenFont < FontFormula
      FULLNAME = "Oxygen".freeze
      CLEANNAME = "Oxygen".freeze

      desc FULLNAME
      homepage "newtypography.co.uk"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Oxygen"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Oxygen-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Oxygen-Light.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class LimelightFont < FontFormula
      FULLNAME = "Limelight".freeze
      CLEANNAME = "Limelight".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Limelight"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Limelight-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Limelight-Regular.ttf", :exist?
        end
      end

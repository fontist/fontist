module Fontist
  module Formulas
    class SansitaFont < FontFormula
      FULLNAME = "Sansita".freeze
      CLEANNAME = "Sansita".freeze

      desc FULLNAME
      homepage "http://www.omnibus-type.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Sansita"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Sansita-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Sansita-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class SedgwickAveFont < FontFormula
      FULLNAME = "Sedgwick Ave".freeze
      CLEANNAME = "SedgwickAve".freeze

      desc FULLNAME
      homepage "http://fonts.google.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Sedgwick%20Ave"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/SedgwickAve-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/SedgwickAve-Regular.ttf", :exist?
        end
      end

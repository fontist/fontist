module Fontist
  module Formulas
    class TekoFont < FontFormula
      FULLNAME = "Teko".freeze
      CLEANNAME = "Teko".freeze

      desc FULLNAME
      homepage "http://www.indiantypefoundry.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Teko"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Teko-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Teko-Light.ttf", :exist?
        end
      end

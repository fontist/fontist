  ...
  module Formulas
    class K2DFont < FontFormula
      ...
      provides_font(FULLNAME, match_styles_from_file: {
        "Thin" => "K2D-Thin.ttf",
        "ThinItalic" => "K2D-ThinItalic.ttf",
        "ExtraLight" => "K2D-ExtraLight.ttf",
        "ExtraLightItalic" => "K2D-ExtraLightItalic.ttf",
        "Light" => "K2D-Light.ttf",
        "LightItalic" => "K2D-LightItalic.ttf",
        "Regular" => "K2D-Regular.ttf",
        "Italic" => "K2D-Italic.ttf",
        "Medium" => "K2D-Medium.ttf",
        "MediumItalic" => "K2D-MediumItalic.ttf",
        "SemiBold" => "K2D-SemiBold.ttf",
        "SemiBoldItalic" => "K2D-SemiBoldItalic.ttf",
        "Bold" => "K2D-Bold.ttf",
        "BoldItalic" => "K2D-BoldItalic.ttf",
        "ExtraBold" => "K2D-ExtraBold.ttf",
        "ExtraBoldItalic" => "K2D-ExtraBoldItalic.ttf",
      })

module Fontist
  module Formulas
    class KumarOneFont < FontFormula
      FULLNAME = "Kumar One".freeze
      CLEANNAME = "KumarOne".freeze

      desc FULLNAME
      homepage "http://www.indiantypefoundry.com/googlefonts"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Kumar%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/KumarOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/KumarOne-Regular.ttf", :exist?
        end
      end

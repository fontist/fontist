module Fontist
  module Formulas
    class VT323Font < FontFormula
      FULLNAME = "VT323".freeze
      CLEANNAME = "VT323".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/VT323-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/VT323-Regular.ttf", :exist?
        end
      end

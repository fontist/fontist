module Fontist
  module Formulas
    class HandleeFont < FontFormula
      FULLNAME = "Handlee".freeze
      CLEANNAME = "Handlee".freeze

      desc FULLNAME
      homepage "http://www.admixdesigns.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Handlee"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Handlee-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Handlee-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class AleoFont < FontFormula
      FULLNAME = "Aleo".freeze
      CLEANNAME = "Aleo".freeze

      desc FULLNAME
      homepage "https://alessiolaiso.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Aleo"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Aleo-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Aleo-Light.ttf", :exist?
        end
      end

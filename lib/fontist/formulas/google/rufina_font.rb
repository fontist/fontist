module Fontist
  module Formulas
    class RufinaFont < FontFormula
      FULLNAME = "Rufina".freeze
      CLEANNAME = "Rufina".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Rufina"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Rufina-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Rufina-Regular.ttf", :exist?
        end
      end

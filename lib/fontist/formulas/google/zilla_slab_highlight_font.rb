module Fontist
  module Formulas
    class ZillaSlabHighlightFont < FontFormula
      FULLNAME = "Zilla Slab Highlight".freeze
      CLEANNAME = "ZillaSlabHighlight".freeze

      desc FULLNAME
      homepage "http://www.typotheque.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Zilla%20Slab%20Highlight"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ZillaSlabHighlight-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ZillaSlabHighlight-Regular.ttf", :exist?
        end
      end

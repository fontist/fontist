module Fontist
  module Formulas
    class GFSNeohellenicFont < FontFormula
      FULLNAME = "GFS Neohellenic".freeze
      CLEANNAME = "GFSNeohellenic".freeze

      desc FULLNAME
      homepage "www.greekfontsociety.org"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=GFS%20Neohellenic"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/GFSNeohellenic.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/GFSNeohellenic.ttf", :exist?
        end
      end

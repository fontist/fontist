module Fontist
  module Formulas
    class PollerOneFont < FontFormula
      FULLNAME = "Poller One".freeze
      CLEANNAME = "PollerOne".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Poller%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PollerOne.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PollerOne.ttf", :exist?
        end
      end

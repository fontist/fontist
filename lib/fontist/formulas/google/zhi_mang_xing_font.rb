module Fontist
  module Formulas
    class ZhiMangXingFont < FontFormula
      FULLNAME = "Zhi Mang Xing".freeze
      CLEANNAME = "ZhiMangXing".freeze

      desc FULLNAME
      homepage "http://www.zhongqifont.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Zhi%20Mang%20Xing"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ZhiMangXing-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ZhiMangXing-Regular.ttf", :exist?
        end
      end

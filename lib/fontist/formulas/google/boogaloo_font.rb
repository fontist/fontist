module Fontist
  module Formulas
    class BoogalooFont < FontFormula
      FULLNAME = "Boogaloo".freeze
      CLEANNAME = "Boogaloo".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Boogaloo"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Boogaloo-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Boogaloo-Regular.ttf", :exist?
        end
      end

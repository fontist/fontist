module Fontist
  module Formulas
    class DeliusFont < FontFormula
      FULLNAME = "Delius".freeze
      CLEANNAME = "Delius".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Delius"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Delius-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Delius-Regular.ttf", :exist?
        end
      end

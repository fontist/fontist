module Fontist
  module Formulas
    class UncialAntiquaFont < FontFormula
      FULLNAME = "Uncial Antiqua".freeze
      CLEANNAME = "UncialAntiqua".freeze

      desc FULLNAME
      homepage "http://www.astigmatic.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Uncial%20Antiqua"
...
Font Name \"Uncial Antiqua\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/UncialAntiqua-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/UncialAntiqua-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        ...
        (astigma@astigmatic.com), with Reserved Font Names "Uncial Antiqua"

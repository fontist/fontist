module Fontist
  module Formulas
    class OpenSansCondensedFont < FontFormula
      FULLNAME = "Open Sans Condensed".freeze
      CLEANNAME = "OpenSansCondensed".freeze

      desc FULLNAME
      homepage "http://www.ascendercorp.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Open%20Sans%20Condensed"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/OpenSansCondensed-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/OpenSansCondensed-Light.ttf", :exist?
        end
      end

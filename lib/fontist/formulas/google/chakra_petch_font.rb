module Fontist
  module Formulas
    class ChakraPetchFont < FontFormula
      FULLNAME = "Chakra Petch".freeze
      CLEANNAME = "ChakraPetch".freeze

      desc FULLNAME
      homepage "http://www.cadsondemak.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Chakra%20Petch"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ChakraPetch-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ChakraPetch-Light.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class CevicheOneFont < FontFormula
      FULLNAME = "Ceviche One".freeze
      CLEANNAME = "CevicheOne".freeze

      desc FULLNAME
      homepage "www.latinotype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ceviche%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/CevicheOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/CevicheOne-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class AdobeBlankFont < FontFormula
      FULLNAME = "Adobe Blank".freeze
      CLEANNAME = "AdobeBlank".freeze

      desc FULLNAME
      homepage "http://www.adobe.com/type/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Adobe%20Blank"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/AdobeBlank-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/AdobeBlank-Regular.ttf", :exist?
        end
      end

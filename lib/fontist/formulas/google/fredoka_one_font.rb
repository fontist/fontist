module Fontist
  module Formulas
    class FredokaOneFont < FontFormula
      FULLNAME = "Fredoka One".freeze
      CLEANNAME = "FredokaOne".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Fredoka%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/FredokaOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/FredokaOne-Regular.ttf", :exist?
        end
      end

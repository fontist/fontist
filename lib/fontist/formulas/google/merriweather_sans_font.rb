module Fontist
  module Formulas
    class MerriweatherSansFont < FontFormula
      FULLNAME = "Merriweather Sans".freeze
      CLEANNAME = "MerriweatherSans".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/MerriweatherSans[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/MerriweatherSans[wght].ttf", :exist?
        end
      end

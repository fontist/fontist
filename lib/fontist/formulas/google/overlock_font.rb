module Fontist
  module Formulas
    class OverlockFont < FontFormula
      FULLNAME = "Overlock".freeze
      CLEANNAME = "Overlock".freeze

      desc FULLNAME
      homepage "www.tipo.net.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Overlock"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Overlock-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Overlock-Regular.ttf", :exist?
        end
      end

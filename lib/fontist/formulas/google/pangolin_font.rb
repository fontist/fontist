module Fontist
  module Formulas
    class PangolinFont < FontFormula
      FULLNAME = "Pangolin".freeze
      CLEANNAME = "Pangolin".freeze

      desc FULLNAME
      homepage "http://fonts.google.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Pangolin"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Pangolin-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Pangolin-Regular.ttf", :exist?
        end
      end

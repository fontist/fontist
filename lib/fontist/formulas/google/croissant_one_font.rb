module Fontist
  module Formulas
    class CroissantOneFont < FontFormula
      FULLNAME = "Croissant One".freeze
      CLEANNAME = "CroissantOne".freeze

      desc FULLNAME
      homepage "http://www.tipo.net.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Croissant%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/CroissantOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/CroissantOne-Regular.ttf", :exist?
        end
      end

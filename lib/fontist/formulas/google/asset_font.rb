module Fontist
  module Formulas
    class AssetFont < FontFormula
      FULLNAME = "Asset".freeze
      CLEANNAME = "Asset".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Asset"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Asset-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Asset-Regular.ttf", :exist?
        end
      end

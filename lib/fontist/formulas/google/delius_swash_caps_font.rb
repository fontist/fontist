module Fontist
  module Formulas
    class DeliusSwashCapsFont < FontFormula
      FULLNAME = "Delius Swash Caps".freeze
      CLEANNAME = "DeliusSwashCaps".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Delius%20Swash%20Caps"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/DeliusSwashCaps-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/DeliusSwashCaps-Regular.ttf", :exist?
        end
      end

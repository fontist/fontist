module Fontist
  module Formulas
    class NTRFont < FontFormula
      FULLNAME = "NTR".freeze
      CLEANNAME = "NTR".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=NTR"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/NTR-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/NTR-Regular.ttf", :exist?
        end
      end

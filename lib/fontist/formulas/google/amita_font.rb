module Fontist
  module Formulas
    class AmitaFont < FontFormula
      FULLNAME = "Amita".freeze
      CLEANNAME = "Amita".freeze

      desc FULLNAME
      homepage "http://www.tipo.net.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Amita"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Amita-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Amita-Regular.ttf", :exist?
        end
      end

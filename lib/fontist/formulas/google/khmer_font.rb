module Fontist
  module Formulas
    class KhmerFont < FontFormula
      FULLNAME = "Khmer".freeze
      CLEANNAME = "Khmer".freeze

      desc FULLNAME
      homepage "http://khmertype.blogspot.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Khmer"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Khmer.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Khmer.ttf", :exist?
        end
      end

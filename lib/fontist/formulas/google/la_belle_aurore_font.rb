module Fontist
  module Formulas
    class LaBelleAuroreFont < FontFormula
      FULLNAME = "La Belle Aurore".freeze
      CLEANNAME = "LaBelleAurore".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=La%20Belle%20Aurore"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/LaBelleAurore.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/LaBelleAurore.ttf", :exist?
        end
      end

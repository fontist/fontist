module Fontist
  module Formulas
    class MilongaFont < FontFormula
      FULLNAME = "Milonga".freeze
      CLEANNAME = "Milonga".freeze

      desc FULLNAME
      homepage "www.impallari.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Milonga"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Milonga-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Milonga-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class IcebergFont < FontFormula
      FULLNAME = "Iceberg".freeze
      CLEANNAME = "Iceberg".freeze

      desc FULLNAME
      homepage "cyreal.org"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Iceberg"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Iceberg-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Iceberg-Regular.ttf", :exist?
        end
      end

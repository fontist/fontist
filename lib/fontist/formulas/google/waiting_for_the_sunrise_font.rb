module Fontist
  module Formulas
    class WaitingfortheSunriseFont < FontFormula
      FULLNAME = "Waiting for the Sunrise".freeze
      CLEANNAME = "WaitingfortheSunrise".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Waiting%20for%20the%20Sunrise"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/WaitingfortheSunrise.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/WaitingfortheSunrise.ttf", :exist?
        end
      end

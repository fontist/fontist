module Fontist
  module Formulas
    class AcmeFont < FontFormula
      FULLNAME = "Acme".freeze
      CLEANNAME = "Acme".freeze

      desc FULLNAME
      homepage "huertatipografica.com.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Acme"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Acme-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Acme-Regular.ttf", :exist?
        end
      end

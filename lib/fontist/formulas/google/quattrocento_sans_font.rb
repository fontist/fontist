module Fontist
  module Formulas
    class QuattrocentoSansFont < FontFormula
      FULLNAME = "Quattrocento Sans".freeze
      CLEANNAME = "QuattrocentoSans".freeze

      desc FULLNAME
      homepage "www.impallari.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Quattrocento%20Sans"
...
with Reserved Font Name Quattrocento Sans.",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/QuattrocentoSans-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/QuattrocentoSans-Regular.ttf", :exist?
        end
      end

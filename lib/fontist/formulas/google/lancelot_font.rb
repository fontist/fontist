module Fontist
  module Formulas
    class LancelotFont < FontFormula
      FULLNAME = "Lancelot".freeze
      CLEANNAME = "Lancelot".freeze

      desc FULLNAME
      homepage "http://www.marion.korkork.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Lancelot"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Lancelot-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Lancelot-Regular.ttf", :exist?
        end
      end

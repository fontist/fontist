  ...
  module Formulas
    class GrenzeFont < FontFormula
      ...
      provides_font(FULLNAME, match_styles_from_file: {
        "Thin" => "Grenze-Thin.ttf",
        "ThinItalic" => "Grenze-ThinItalic.ttf",
        "ExtraLight" => "Grenze-ExtraLight.ttf",
        "ExtraLightItalic" => "Grenze-ExtraLightItalic.ttf",
        "Light" => "Grenze-Light.ttf",
        "LightItalic" => "Grenze-LightItalic.ttf",
        "Regular" => "Grenze-Regular.ttf",
        "Italic" => "Grenze-Italic.ttf",
        "Medium" => "Grenze-Medium.ttf",
        "MediumItalic" => "Grenze-MediumItalic.ttf",
        "SemiBold" => "Grenze-SemiBold.ttf",
        "SemiBoldItalic" => "Grenze-SemiBoldItalic.ttf",
        "Bold" => "Grenze-Bold.ttf",
        "BoldItalic" => "Grenze-BoldItalic.ttf",
        "ExtraBold" => "Grenze-ExtraBold.ttf",
        "ExtraBoldItalic" => "Grenze-ExtraBoldItalic.ttf",
        "Black" => "Grenze-Black.ttf",
        "BlackItalic" => "Grenze-BlackItalic.ttf",
      })

module Fontist
  module Formulas
    class IMFellFrenchCanonFont < FontFormula
      FULLNAME = "IM Fell French Canon".freeze
      CLEANNAME = "IMFellFrenchCanon".freeze

      desc FULLNAME
      homepage "www.iginomarini.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=IM%20Fell%20French%20Canon"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/IMFeFCrm28P.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/IMFeFCrm28P.ttf", :exist?
        end
      end

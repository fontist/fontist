module Fontist
  module Formulas
    class LondrinaSolidFont < FontFormula
      FULLNAME = "Londrina Solid".freeze
      CLEANNAME = "LondrinaSolid".freeze

      desc FULLNAME
      homepage "http://www.tipospereira.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Londrina%20Solid"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/LondrinaSolid-Thin.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/LondrinaSolid-Thin.ttf", :exist?
        end
      end

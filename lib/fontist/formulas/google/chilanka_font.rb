module Fontist
  module Formulas
    class ChilankaFont < FontFormula
      FULLNAME = "Chilanka".freeze
      CLEANNAME = "Chilanka".freeze

      desc FULLNAME
      homepage "https://smc.org.in"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Chilanka"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Chilanka-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Chilanka-Regular.ttf", :exist?
        end
      end

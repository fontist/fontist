module Fontist
  module Formulas
    class MetrophobicFont < FontFormula
      FULLNAME = "Metrophobic".freeze
      CLEANNAME = "Metrophobic".freeze

      desc FULLNAME
      homepage "http://www.sansoxygen.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Metrophobic"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Metrophobic-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Metrophobic-Regular.ttf", :exist?
        end
      end

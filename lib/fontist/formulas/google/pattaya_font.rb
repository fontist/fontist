module Fontist
  module Formulas
    class PattayaFont < FontFormula
      FULLNAME = "Pattaya".freeze
      CLEANNAME = "Pattaya".freeze

      desc FULLNAME
      homepage "www.impallari.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Pattaya"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Pattaya-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Pattaya-Regular.ttf", :exist?
        end
      end

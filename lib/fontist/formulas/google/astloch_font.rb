module Fontist
  module Formulas
    class AstlochFont < FontFormula
      FULLNAME = "Astloch".freeze
      CLEANNAME = "Astloch".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Astloch"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Astloch-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Astloch-Regular.ttf", :exist?
        end
      end

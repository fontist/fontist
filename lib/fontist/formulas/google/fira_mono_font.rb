module Fontist
  module Formulas
    class FiraMonoFont < FontFormula
      FULLNAME = "Fira Mono".freeze
      CLEANNAME = "FiraMono".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/FiraMono-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/FiraMono-Regular.ttf", :exist?
        end
      end

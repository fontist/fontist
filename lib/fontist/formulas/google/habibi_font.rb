module Fontist
  module Formulas
    class HabibiFont < FontFormula
      FULLNAME = "Habibi".freeze
      CLEANNAME = "Habibi".freeze

      desc FULLNAME
      homepage "sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Habibi"
...
with Reserved Font Name \"Habibi\".",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Habibi-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Habibi-Regular.ttf", :exist?
        end
      end

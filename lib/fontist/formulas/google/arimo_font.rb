module Fontist
  module Formulas
    class ArimoFont < FontFormula
      FULLNAME = "Arimo".freeze
      CLEANNAME = "Arimo".freeze

      desc FULLNAME
      homepage "http://www.monotypeimaging.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Arimo"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Arimo-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Arimo-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class AlataFont < FontFormula
      FULLNAME = "Alata".freeze
      CLEANNAME = "Alata".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Alata"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Alata-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Alata-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class TurretRoadFont < FontFormula
      FULLNAME = "Turret Road".freeze
      CLEANNAME = "TurretRoad".freeze

      desc FULLNAME
      homepage "http://noponies.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Turret%20Road"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/TurretRoad-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/TurretRoad-ExtraLight.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class AsarFont < FontFormula
      FULLNAME = "Asar".freeze
      CLEANNAME = "Asar".freeze

      desc FULLNAME
      homepage "sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Asar"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Asar-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Asar-Regular.ttf", :exist?
        end
      end

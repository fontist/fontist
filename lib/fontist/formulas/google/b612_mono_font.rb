module Fontist
  module Formulas
    class B612MonoFont < FontFormula
      FULLNAME = "B612 Mono".freeze
      CLEANNAME = "B612Mono".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=B612%20Mono"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/B612Mono-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/B612Mono-Regular.ttf", :exist?
        end
      end

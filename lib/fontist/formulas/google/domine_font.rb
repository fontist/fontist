module Fontist
  module Formulas
    class DomineFont < FontFormula
      FULLNAME = "Domine".freeze
      CLEANNAME = "Domine".freeze

      desc FULLNAME
      homepage "www.impallari.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Domine"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Domine[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Domine[wght].ttf", :exist?
        end
      end

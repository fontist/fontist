module Fontist
  module Formulas
    class BalooTammaFont < FontFormula
      FULLNAME = "Baloo Tamma".freeze
      CLEANNAME = "BalooTamma".freeze

      desc FULLNAME
      homepage "www.ektype.in"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Baloo%20Tamma"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/BalooTamma-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/BalooTamma-Regular.ttf", :exist?
        end
      end

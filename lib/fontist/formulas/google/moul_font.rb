module Fontist
  module Formulas
    class MoulFont < FontFormula
      FULLNAME = "Moul".freeze
      CLEANNAME = "Moul".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Moul"
        sha256 "4a008aaf307c3d6fb6ef886f25afe69c9ffb12f29b9bcce0bd993e13acac7ed5"
      end
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Moul.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Moul.ttf", :exist?
        end
      end

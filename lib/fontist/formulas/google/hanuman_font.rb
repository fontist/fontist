module Fontist
  module Formulas
    class HanumanFont < FontFormula
      FULLNAME = "Hanuman".freeze
      CLEANNAME = "Hanuman".freeze

      desc FULLNAME
      homepage "http://www.khmertype.blogspot.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Hanuman"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Hanuman-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Hanuman-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class BarriecitoFont < FontFormula
      FULLNAME = "Barriecito".freeze
      CLEANNAME = "Barriecito".freeze

      desc FULLNAME
      homepage "http://www.omnibus-type.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Barriecito"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Barriecito-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Barriecito-Regular.ttf", :exist?
        end
      end

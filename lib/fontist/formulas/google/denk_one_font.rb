module Fontist
  module Formulas
    class DenkOneFont < FontFormula
      FULLNAME = "Denk One".freeze
      CLEANNAME = "DenkOne".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Denk%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/DenkOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/DenkOne-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        Copyright (c) 2012 by Sorkin Type Co (www.sorkintype.com), with Reserved Font Name 'Denk'

        Denk is a trademark of Sorkin Type Co.

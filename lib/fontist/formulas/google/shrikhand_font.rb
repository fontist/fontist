module Fontist
  module Formulas
    class ShrikhandFont < FontFormula
      FULLNAME = "Shrikhand".freeze
      CLEANNAME = "Shrikhand".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Shrikhand"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Shrikhand-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Shrikhand-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class BerkshireSwashFont < FontFormula
      FULLNAME = "Berkshire Swash".freeze
      CLEANNAME = "BerkshireSwash".freeze

      desc FULLNAME
      homepage "http://www.astigmatic.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Berkshire%20Swash"
...
Font Name \"Berkshire Swash\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/BerkshireSwash-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/BerkshireSwash-Regular.ttf", :exist?
        end
      end

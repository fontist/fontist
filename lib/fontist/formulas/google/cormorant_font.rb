module Fontist
  module Formulas
    class CormorantFont < FontFormula
      FULLNAME = "Cormorant".freeze
      CLEANNAME = "Cormorant".freeze

      desc FULLNAME
      homepage "https://github.com/CatharsisFonts"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Cormorant"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Cormorant-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Cormorant-Light.ttf", :exist?
        end
      end

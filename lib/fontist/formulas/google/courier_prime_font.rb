module Fontist
  module Formulas
    class CourierPrimeFont < FontFormula
      FULLNAME = "Courier Prime".freeze
      CLEANNAME = "CourierPrime".freeze

      desc FULLNAME
      homepage "http://quoteunquoteapps.com"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/CourierPrime-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/CourierPrime-Regular.ttf", :exist?
        end
      end

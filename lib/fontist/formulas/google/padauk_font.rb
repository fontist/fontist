module Fontist
  module Formulas
    class PadaukFont < FontFormula
      FULLNAME = "Padauk".freeze
      CLEANNAME = "Padauk".freeze

      desc FULLNAME
      homepage "http://scripts.sil.org"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Padauk"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Padauk-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Padauk-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        Copyright 2013 SIL International, all rights reserved with Reserved Font Name "Padauk".

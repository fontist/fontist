module Fontist
  module Formulas
    class LemonFont < FontFormula
      FULLNAME = "Lemon".freeze
      CLEANNAME = "Lemon".freeze

      desc FULLNAME
      homepage "http://www.tipo.net.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Lemon"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Lemon-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Lemon-Regular.ttf", :exist?
        end
      end

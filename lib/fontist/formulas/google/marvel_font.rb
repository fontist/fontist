module Fontist
  module Formulas
    class MarvelFont < FontFormula
      FULLNAME = "Marvel".freeze
      CLEANNAME = "Marvel".freeze

      desc FULLNAME
      homepage "fromzero.org"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Marvel"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Marvel-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Marvel-Regular.ttf", :exist?
        end
      end

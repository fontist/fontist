module Fontist
  module Formulas
    class SyncopateFont < FontFormula
      FULLNAME = "Syncopate".freeze
      CLEANNAME = "Syncopate".freeze

      desc FULLNAME
      homepage "http://www.astigmatic.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Syncopate"
...
http://www.apache.org/licenses/LICENSE-2.0.html",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Syncopate-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Syncopate-Regular.ttf", :exist?
        end
      end

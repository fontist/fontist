module Fontist
  module Formulas
    class HomenajeFont < FontFormula
      FULLNAME = "Homenaje".freeze
      CLEANNAME = "Homenaje".freeze

      desc FULLNAME
      homepage "agustinamingote@gmail.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Homenaje"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Homenaje-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Homenaje-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class LifeSaversFont < FontFormula
      FULLNAME = "Life Savers".freeze
      CLEANNAME = "LifeSavers".freeze

      desc FULLNAME
      homepage "www.impallari.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Life%20Savers"
...
with Reserved Font Name Life Savers.",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/LifeSavers-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/LifeSavers-Regular.ttf", :exist?
        end
      end

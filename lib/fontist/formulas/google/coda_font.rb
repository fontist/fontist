module Fontist
  module Formulas
    class CodaFont < FontFormula
      FULLNAME = "Coda".freeze
      CLEANNAME = "Coda".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Coda"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Coda-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Coda-Regular.ttf", :exist?
        end
      end

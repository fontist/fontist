module Fontist
  module Formulas
    class ConcertOneFont < FontFormula
      FULLNAME = "Concert One".freeze
      CLEANNAME = "ConcertOne".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Concert%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ConcertOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ConcertOne-Regular.ttf", :exist?
        end
      end

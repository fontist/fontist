module Fontist
  module Formulas
    class PassionOneFont < FontFormula
      FULLNAME = "Passion One".freeze
      CLEANNAME = "PassionOne".freeze

      desc FULLNAME
      homepage "www.fontstage.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Passion%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PassionOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PassionOne-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        Copyright (c) 2011 Fontstage (info@fontstage.com), with Reserved Font Names, 'Passion'

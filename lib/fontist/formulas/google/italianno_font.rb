module Fontist
  module Formulas
    class ItaliannoFont < FontFormula
      FULLNAME = "Italianno".freeze
      CLEANNAME = "Italianno".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Italianno"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Italianno-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Italianno-Regular.ttf", :exist?
        end
      end

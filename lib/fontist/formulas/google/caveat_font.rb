module Fontist
  module Formulas
    class CaveatFont < FontFormula
      FULLNAME = "Caveat".freeze
      CLEANNAME = "Caveat".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Caveat-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Caveat-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class ChicleFont < FontFormula
      FULLNAME = "Chicle".freeze
      CLEANNAME = "Chicle".freeze

      desc FULLNAME
      homepage "http://www.sudtipos.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Chicle"
...
with Reserved Font Name \"Chicle\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Chicle-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Chicle-Regular.ttf", :exist?
        end
      end

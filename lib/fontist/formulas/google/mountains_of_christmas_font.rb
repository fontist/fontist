module Fontist
  module Formulas
    class MountainsofChristmasFont < FontFormula
      FULLNAME = "Mountains of Christmas".freeze
      CLEANNAME = "MountainsofChristmas".freeze

      desc FULLNAME
      homepage "http://www.fontbros.com/tartworkshop.php"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Mountains%20of%20Christmas"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/MountainsofChristmas-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/MountainsofChristmas-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class VarelaRoundFont < FontFormula
      FULLNAME = "Varela Round".freeze
      CLEANNAME = "VarelaRound".freeze

      desc FULLNAME
      homepage "http://www.avrahamcornfeld.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Varela%20Round"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/VarelaRound-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/VarelaRound-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class IMFellGreatPrimerFont < FontFormula
      FULLNAME = "IM Fell Great Primer".freeze
      CLEANNAME = "IMFellGreatPrimer".freeze

      desc FULLNAME
      homepage "www.iginomarini.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=IM%20Fell%20Great%20Primer"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/IMFeGPrm28P.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/IMFeGPrm28P.ttf", :exist?
        end
      end

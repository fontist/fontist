module Fontist
  module Formulas
    class KdamThmorFont < FontFormula
      FULLNAME = "Kdam Thmor".freeze
      CLEANNAME = "KdamThmor".freeze

      desc FULLNAME
      homepage "http://it4ug.net/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Kdam%20Thmor"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/KdamThmor-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/KdamThmor-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        Copyright (c) 2013 by Sovichet Tep with Reserved Font Name "Kdam Thmor".

module Fontist
  module Formulas
    class AveriaSansLibreFont < FontFormula
      FULLNAME = "Averia Sans Libre".freeze
      CLEANNAME = "AveriaSansLibre".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Averia%20Sans%20Libre"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/AveriaSansLibre-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/AveriaSansLibre-Light.ttf", :exist?
        end
      end

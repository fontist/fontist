module Fontist
  module Formulas
    class GelasioFont < FontFormula
      FULLNAME = "Gelasio".freeze
      CLEANNAME = "Gelasio".freeze

      desc FULLNAME
      homepage "sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Gelasio"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Gelasio-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Gelasio-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        Copyright 2019 The Gelasio Project Authors (https://github.com/sorkintype/Gelasio)

module Fontist
  module Formulas
    class VartaFont < FontFormula
      FULLNAME = "Varta".freeze
      CLEANNAME = "Varta".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Varta"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Varta[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Varta[wght].ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class BowlbyOneFont < FontFormula
      FULLNAME = "Bowlby One".freeze
      CLEANNAME = "BowlbyOne".freeze

      desc FULLNAME
      homepage "http://www.newtypography.co.uk"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Bowlby%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/BowlbyOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/BowlbyOne-Regular.ttf", :exist?
        end
      end

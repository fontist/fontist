module Fontist
  module Formulas
    class LiterataFont < FontFormula
      FULLNAME = "Literata".freeze
      CLEANNAME = "Literata".freeze

      desc FULLNAME
      homepage "http://www.google.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Literata"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Literata[opsz,wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Literata[opsz,wght].ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class ZCOOLXiaoWeiFont < FontFormula
      FULLNAME = "ZCOOL XiaoWei".freeze
      CLEANNAME = "ZCOOLXiaoWei".freeze

      desc FULLNAME
      homepage "http://zcool.com.cn"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=ZCOOL%20XiaoWei"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ZCOOLXiaoWei-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ZCOOLXiaoWei-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class MiltonianTattooFont < FontFormula
      FULLNAME = "Miltonian Tattoo".freeze
      CLEANNAME = "MiltonianTattoo".freeze

      desc FULLNAME
      homepage "www.impallari.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Miltonian%20Tattoo"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/MiltonianTattoo-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/MiltonianTattoo-Regular.ttf", :exist?
        end
      end

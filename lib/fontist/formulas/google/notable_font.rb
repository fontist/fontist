module Fontist
  module Formulas
    class NotableFont < FontFormula
      FULLNAME = "Notable".freeze
      CLEANNAME = "Notable".freeze

      desc FULLNAME
      homepage "http://fonts.google.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Notable"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Notable-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Notable-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class AbrilFatfaceFont < FontFormula
      FULLNAME = "Abril Fatface".freeze
      CLEANNAME = "AbrilFatface".freeze

      desc FULLNAME
      homepage "www.type-together.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Abril%20Fatface"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/AbrilFatface-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/AbrilFatface-Regular.ttf", :exist?
        end
      end

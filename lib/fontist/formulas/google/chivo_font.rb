module Fontist
  module Formulas
    class ChivoFont < FontFormula
      FULLNAME = "Chivo".freeze
      CLEANNAME = "Chivo".freeze

      desc FULLNAME
      homepage "http://www.omnibus-type.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Chivo"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Chivo-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Chivo-Light.ttf", :exist?
        end
      end

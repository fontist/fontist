module Fontist
  module Formulas
    class IndieFlowerFont < FontFormula
      FULLNAME = "Indie Flower".freeze
      CLEANNAME = "IndieFlower".freeze

      desc FULLNAME
      homepage "http://www.kimberlygeswein.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Indie%20Flower"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/IndieFlower-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/IndieFlower-Regular.ttf", :exist?
        end
      end

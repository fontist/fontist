module Fontist
  module Formulas
    class IbarraRealNovaFont < FontFormula
      FULLNAME = "Ibarra Real Nova".freeze
      CLEANNAME = "IbarraRealNova".freeze

      desc FULLNAME
      homepage "www.octaviopardo.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ibarra%20Real%20Nova"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/IbarraRealNova-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/IbarraRealNova-Regular.ttf", :exist?
        end
      end

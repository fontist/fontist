module Fontist
  module Formulas
    class BaumansFont < FontFormula
      FULLNAME = "Baumans".freeze
      CLEANNAME = "Baumans".freeze

      desc FULLNAME
      homepage "http://cyreal.org"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Baumans"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Baumans-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Baumans-Regular.ttf", :exist?
        end
      end

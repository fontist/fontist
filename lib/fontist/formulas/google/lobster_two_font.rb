module Fontist
  module Formulas
    class LobsterTwoFont < FontFormula
      FULLNAME = "Lobster Two".freeze
      CLEANNAME = "LobsterTwo".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/LobsterTwo-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/LobsterTwo-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class SunflowerFont < FontFormula
      FULLNAME = "Sunflower".freeze
      CLEANNAME = "Sunflower".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Sunflower"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Sunflower-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Sunflower-Light.ttf", :exist?
        end
      end

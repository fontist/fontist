module Fontist
  module Formulas
    class EricaOneFont < FontFormula
      FULLNAME = "Erica One".freeze
      CLEANNAME = "EricaOne".freeze

      desc FULLNAME
      homepage "www.latinotype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Erica%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/EricaOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/EricaOne-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class TinosFont < FontFormula
      FULLNAME = "Tinos".freeze
      CLEANNAME = "Tinos".freeze

      desc FULLNAME
      homepage "http://www.monotypeimaging.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Tinos"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Tinos-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Tinos-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class ArvoFont < FontFormula
      FULLNAME = "Arvo".freeze
      CLEANNAME = "Arvo".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Arvo"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Arvo-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Arvo-Regular.ttf", :exist?
        end
      end

      copyright "Copyright 2010 Anton Koovit."
      license_url "http://www.korkork.com/license/arvo/"

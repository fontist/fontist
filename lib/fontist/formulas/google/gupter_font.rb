module Fontist
  module Formulas
    class GupterFont < FontFormula
      FULLNAME = "Gupter".freeze
      CLEANNAME = "Gupter".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Gupter"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Gupter-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Gupter-Regular.ttf", :exist?
        end
      end

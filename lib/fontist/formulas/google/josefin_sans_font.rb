module Fontist
  module Formulas
    class JosefinSansFont < FontFormula
      FULLNAME = "Josefin Sans".freeze
      CLEANNAME = "JosefinSans".freeze

      desc FULLNAME
      homepage "http://www.typemade.mx"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Josefin%20Sans"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/JosefinSans[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/JosefinSans[wght].ttf", :exist?
        end
      end

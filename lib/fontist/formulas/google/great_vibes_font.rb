module Fontist
  module Formulas
    class GreatVibesFont < FontFormula
      FULLNAME = "Great Vibes".freeze
      CLEANNAME = "GreatVibes".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Great%20Vibes"
...
with Reserved Font Name \"Great Vibes\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/GreatVibes-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/GreatVibes-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class BreeSerifFont < FontFormula
      FULLNAME = "Bree Serif".freeze
      CLEANNAME = "BreeSerif".freeze

      desc FULLNAME
      homepage "www.type-together.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Bree%20Serif"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/BreeSerif-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/BreeSerif-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class HalantFont < FontFormula
      FULLNAME = "Halant".freeze
      CLEANNAME = "Halant".freeze

      desc FULLNAME
      homepage "http://www.indiantypefoundry.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Halant"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Halant-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Halant-Light.ttf", :exist?
        end
      end

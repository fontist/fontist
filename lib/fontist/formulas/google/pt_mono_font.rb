module Fontist
  module Formulas
    class PTMonoFont < FontFormula
      FULLNAME = "PT Mono".freeze
      CLEANNAME = "PTMono".freeze

      desc FULLNAME
      homepage "http://www.paratype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=PT%20Mono"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PTM55FT.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PTM55FT.ttf", :exist?
        end
      end

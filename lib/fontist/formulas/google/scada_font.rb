module Fontist
  module Formulas
    class ScadaFont < FontFormula
      FULLNAME = "Scada".freeze
      CLEANNAME = "Scada".freeze

      desc FULLNAME
      homepage "http://scada.lv/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Scada"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Scada-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Scada-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class HindGunturFont < FontFormula
      FULLNAME = "Hind Guntur".freeze
      CLEANNAME = "HindGuntur".freeze

      desc FULLNAME
      homepage "https://github.com/itfoundry/hind-guntur"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Hind%20Guntur"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/HindGuntur-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/HindGuntur-Light.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class ArizoniaFont < FontFormula
      FULLNAME = "Arizonia".freeze
      CLEANNAME = "Arizonia".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Arizonia"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Arizonia-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Arizonia-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class AmiriFont < FontFormula
      FULLNAME = "Amiri".freeze
      CLEANNAME = "Amiri".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Amiri-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Amiri-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class PlayballFont < FontFormula
      FULLNAME = "Playball".freeze
      CLEANNAME = "Playball".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Playball"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Playball-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Playball-Regular.ttf", :exist?
        end
      end

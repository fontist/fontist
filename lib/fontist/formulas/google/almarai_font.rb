module Fontist
  module Formulas
    class AlmaraiFont < FontFormula
      FULLNAME = "Almarai".freeze
      CLEANNAME = "Almarai".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Almarai"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Almarai-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Almarai-Light.ttf", :exist?
        end
      end

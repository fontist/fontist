module Fontist
  module Formulas
    class FjallaOneFont < FontFormula
      FULLNAME = "Fjalla One".freeze
      CLEANNAME = "FjallaOne".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Fjalla%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/FjallaOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/FjallaOne-Regular.ttf", :exist?
        end
      end

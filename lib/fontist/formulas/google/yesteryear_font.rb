module Fontist
  module Formulas
    class YesteryearFont < FontFormula
      FULLNAME = "Yesteryear".freeze
      CLEANNAME = "Yesteryear".freeze

      desc FULLNAME
      homepage "http://www.astigmatic.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Yesteryear"
...
Font Name \"Yesteryear\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Yesteryear-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Yesteryear-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class CormorantGaramondFont < FontFormula
      FULLNAME = "Cormorant Garamond".freeze
      CLEANNAME = "CormorantGaramond".freeze

      desc FULLNAME
      homepage "https://github.com/CatharsisFonts"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Cormorant%20Garamond"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/CormorantGaramond-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/CormorantGaramond-Light.ttf", :exist?
        end
      end

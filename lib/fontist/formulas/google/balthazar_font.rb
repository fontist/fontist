module Fontist
  module Formulas
    class BalthazarFont < FontFormula
      FULLNAME = "Balthazar".freeze
      CLEANNAME = "Balthazar".freeze

      desc FULLNAME
      homepage "http://www.tipo.net.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Balthazar"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Balthazar-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Balthazar-Regular.ttf", :exist?
        end
      end

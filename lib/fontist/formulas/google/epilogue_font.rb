module Fontist
  module Formulas
    class EpilogueFont < FontFormula
      FULLNAME = "Epilogue".freeze
      CLEANNAME = "Epilogue".freeze

      desc FULLNAME
      homepage "https://www.etceteratype.co"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Epilogue"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Epilogue[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Epilogue[wght].ttf", :exist?
        end
      end

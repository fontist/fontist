module Fontist
  module Formulas
    class IMFellDWPicaFont < FontFormula
      FULLNAME = "IM Fell DW Pica".freeze
      CLEANNAME = "IMFellDWPica".freeze

      desc FULLNAME
      homepage "www.iginomarini.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=IM%20Fell%20DW%20Pica"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/IMFePIrm28P.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/IMFePIrm28P.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class BubblegumSansFont < FontFormula
      FULLNAME = "Bubblegum Sans".freeze
      CLEANNAME = "BubblegumSans".freeze

      desc FULLNAME
      homepage "http://www.sudtipos.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Bubblegum%20Sans"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/BubblegumSans-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/BubblegumSans-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class PlayfairDisplayFont < FontFormula
      FULLNAME = "Playfair Display".freeze
      CLEANNAME = "PlayfairDisplay".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PlayfairDisplay[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PlayfairDisplay[wght].ttf", :exist?
        end
      end

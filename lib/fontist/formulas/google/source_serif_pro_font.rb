module Fontist
  module Formulas
    class SourceSerifProFont < FontFormula
      FULLNAME = "Source Serif Pro".freeze
      CLEANNAME = "SourceSerifPro".freeze
      ...
      resource "#{CLEANNAME}.zip" do
        ...
        sha256 "97aa982159c05213a82b954383077338a65673ae6a8c85b5615776e7fc9d0bdb"
      end

      provides_font(FULLNAME, match_styles_from_file: {
        "ExtraLight" => "SourceSerifPro-ExtraLight.ttf",
        "ExtraLightItalic" => "SourceSerifPro-ExtraLightItalic.ttf",
        "Light" => "SourceSerifPro-Light.ttf",
        "LightItalic" => "SourceSerifPro-LightItalic.ttf",
        "Regular" => "SourceSerifPro-Regular.ttf",
        "Italic" => "SourceSerifPro-Italic.ttf",
        "SemiBold" => "SourceSerifPro-SemiBold.ttf",
        "SemiBoldItalic" => "SourceSerifPro-SemiBoldItalic.ttf",
        "Bold" => "SourceSerifPro-Bold.ttf",
        "BoldItalic" => "SourceSerifPro-BoldItalic.ttf",
        "Black" => "SourceSerifPro-Black.ttf",
        "BlackItalic" => "SourceSerifPro-BlackItalic.ttf",
      })
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/SourceSerifPro-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/SourceSerifPro-ExtraLight.ttf", :exist?
        end
      end

  ...
  module Formulas
    class SarabunFont < FontFormula
      ...
      provides_font(FULLNAME, match_styles_from_file: {
        ...
        "ThinItalic" => "Sarabun-ThinItalic.ttf",
        "ExtraLight" => "Sarabun-ExtraLight.ttf",
        "ExtraLightItalic" => "Sarabun-ExtraLightItalic.ttf",
        "Light" => "Sarabun-Light.ttf",
        "LightItalic" => "Sarabun-LightItalic.ttf",
        "Regular" => "Sarabun-Regular.ttf",
        "Italic" => "Sarabun-Italic.ttf",
        "Medium" => "Sarabun-Medium.ttf",
        "MediumItalic" => "Sarabun-MediumItalic.ttf",
        "SemiBold" => "Sarabun-SemiBold.ttf",
        "SemiBoldItalic" => "Sarabun-SemiBoldItalic.ttf",
        "Bold" => "Sarabun-Bold.ttf",
        "BoldItalic" => "Sarabun-BoldItalic.ttf",
        "ExtraBold" => "Sarabun-ExtraBold.ttf",
        "ExtraBoldItalic" => "Sarabun-ExtraBoldItalic.ttf",
      })

module Fontist
  module Formulas
    class CormorantUprightFont < FontFormula
      FULLNAME = "Cormorant Upright".freeze
      CLEANNAME = "CormorantUpright".freeze

      desc FULLNAME
      homepage "https://github.com/CatharsisFonts"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Cormorant%20Upright"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/CormorantUpright-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/CormorantUpright-Light.ttf", :exist?
        end
      end

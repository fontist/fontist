module Fontist
  module Formulas
    class SeymourOneFont < FontFormula
      FULLNAME = "Seymour One".freeze
      CLEANNAME = "SeymourOne".freeze

      desc FULLNAME
      homepage "newtypography.co.uk"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Seymour%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/SeymourOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/SeymourOne-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        ...
        with Reserved Font Name 'Seymour' and 'Seymour One'.

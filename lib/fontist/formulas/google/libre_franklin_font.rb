  ...
  module Formulas
    class LibreFranklinFont < FontFormula
      ...
      provides_font(FULLNAME, match_styles_from_file: {
        "Thin" => "LibreFranklin-Thin.ttf",
        "ThinItalic" => "LibreFranklin-ThinItalic.ttf",
        "ExtraLight" => "LibreFranklin-ExtraLight.ttf",
        "ExtraLightItalic" => "LibreFranklin-ExtraLightItalic.ttf",
        "Light" => "LibreFranklin-Light.ttf",
        "LightItalic" => "LibreFranklin-LightItalic.ttf",
        "Regular" => "LibreFranklin-Regular.ttf",
        "Italic" => "LibreFranklin-Italic.ttf",
        ...
        "ExtraBold" => "LibreFranklin-ExtraBold.ttf",
        "ExtraBoldItalic" => "LibreFranklin-ExtraBoldItalic.ttf",
        "Black" => "LibreFranklin-Black.ttf",
        "BlackItalic" => "LibreFranklin-BlackItalic.ttf",
      })

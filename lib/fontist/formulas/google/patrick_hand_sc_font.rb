module Fontist
  module Formulas
    class PatrickHandSCFont < FontFormula
      FULLNAME = "Patrick Hand SC".freeze
      CLEANNAME = "PatrickHandSC".freeze

      desc FULLNAME
      homepage "http://www.patrickwagesreiter.at"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Patrick%20Hand%20SC"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PatrickHandSC-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PatrickHandSC-Regular.ttf", :exist?
        end
      end

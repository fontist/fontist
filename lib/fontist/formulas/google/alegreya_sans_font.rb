  ...
  module Formulas
    class AlegreyaSansFont < FontFormula
      ...
      provides_font(FULLNAME, match_styles_from_file: {
        "Thin" => "AlegreyaSans-Thin.ttf",
        "ThinItalic" => "AlegreyaSans-ThinItalic.ttf",
        "Light" => "AlegreyaSans-Light.ttf",
        "LightItalic" => "AlegreyaSans-LightItalic.ttf",
        "Regular" => "AlegreyaSans-Regular.ttf",
        "Italic" => "AlegreyaSans-Italic.ttf",
        "Medium" => "AlegreyaSans-Medium.ttf",
        "MediumItalic" => "AlegreyaSans-MediumItalic.ttf",
        "Bold" => "AlegreyaSans-Bold.ttf",
        "BoldItalic" => "AlegreyaSans-BoldItalic.ttf",
        "ExtraBold" => "AlegreyaSans-ExtraBold.ttf",
        "ExtraBoldItalic" => "AlegreyaSans-ExtraBoldItalic.ttf",
        "Black" => "AlegreyaSans-Black.ttf",
        "BlackItalic" => "AlegreyaSans-BlackItalic.ttf",
      })

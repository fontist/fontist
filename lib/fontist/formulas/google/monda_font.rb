module Fontist
  module Formulas
    class MondaFont < FontFormula
      FULLNAME = "Monda".freeze
      CLEANNAME = "Monda".freeze

      desc FULLNAME
      homepage "http://code.newtypography.co.uk"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Monda"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Monda-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Monda-Regular.ttf", :exist?
        end
      end

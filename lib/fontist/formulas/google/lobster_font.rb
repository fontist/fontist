module Fontist
  module Formulas
    class LobsterFont < FontFormula
      FULLNAME = "Lobster".freeze
      CLEANNAME = "Lobster".freeze

      desc FULLNAME
      homepage "http://www.impallari.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Lobster"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Lobster-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Lobster-Regular.ttf", :exist?
        end
      end

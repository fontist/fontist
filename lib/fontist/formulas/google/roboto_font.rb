module Fontist
  module Formulas
    class RobotoFont < FontFormula
      FULLNAME = "Roboto".freeze
      CLEANNAME = "Roboto".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Roboto[wdth,wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Roboto[wdth,wght].ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class LilyScriptOneFont < FontFormula
      FULLNAME = "Lily Script One".freeze
      CLEANNAME = "LilyScriptOne".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Lily%20Script%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/LilyScriptOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/LilyScriptOne-Regular.ttf", :exist?
        end
      end

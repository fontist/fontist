module Fontist
  module Formulas
    class BigShouldersTextFont < FontFormula
      FULLNAME = "Big Shoulders Text".freeze
      CLEANNAME = "BigShouldersText".freeze

      desc FULLNAME
      homepage "http://xotype.co"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Big%20Shoulders%20Text"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/BigShouldersText-Thin.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/BigShouldersText-Thin.ttf", :exist?
        end
      end

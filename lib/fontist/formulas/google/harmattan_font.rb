module Fontist
  module Formulas
    class HarmattanFont < FontFormula
      FULLNAME = "Harmattan".freeze
      CLEANNAME = "Harmattan".freeze

      desc FULLNAME
      homepage "http://www.sil.org/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Harmattan"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Harmattan-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Harmattan-Regular.ttf", :exist?
        end
      end
...
with Reserved Font Names \"Harmattan\" and \"SIL\"."
      ...
      open_license <<~TEXT
        ...
        an FAQ at: http://scripts.sil.org/OFL

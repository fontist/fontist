module Fontist
  module Formulas
    class BaskervvilleFont < FontFormula
      FULLNAME = "Baskervville".freeze
      CLEANNAME = "Baskervville".freeze

      desc FULLNAME
      homepage "https://anrt-nancy.fr"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Baskervville"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Baskervville-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Baskervville-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class RationaleFont < FontFormula
      FULLNAME = "Rationale".freeze
      CLEANNAME = "Rationale".freeze

      desc FULLNAME
      homepage "http://cyreal.org"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Rationale"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Rationale-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Rationale-Regular.ttf", :exist?
        end
      end

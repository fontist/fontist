module Fontist
  module Formulas
    class CherryBombFont < FontFormula
      FULLNAME = "Cherry Bomb".freeze
      CLEANNAME = "CherryBomb".freeze

      desc FULLNAME
      homepage "https://satsuyako.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Cherry%20Bomb"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/CherryBomb-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/CherryBomb-Regular.ttf", :exist?
        end
      end

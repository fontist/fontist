module Fontist
  module Formulas
    class SanchezFont < FontFormula
      FULLNAME = "Sanchez".freeze
      CLEANNAME = "Sanchez".freeze

      desc FULLNAME
      homepage "www.latinotype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Sanchez"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Sanchez-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Sanchez-Regular.ttf", :exist?
        end
      end

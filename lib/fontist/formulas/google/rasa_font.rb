module Fontist
  module Formulas
    class RasaFont < FontFormula
      FULLNAME = "Rasa".freeze
      CLEANNAME = "Rasa".freeze

      desc FULLNAME
      homepage "http://rosettatype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Rasa"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Rasa-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Rasa-Light.ttf", :exist?
        end
      end

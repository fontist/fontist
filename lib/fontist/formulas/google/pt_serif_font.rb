module Fontist
  module Formulas
    class PTSerifFont < FontFormula
      FULLNAME = "PT Serif".freeze
      CLEANNAME = "PTSerif".freeze

      desc FULLNAME
      homepage "http://www.paratype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=PT%20Serif"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PT_Serif-Web-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PT_Serif-Web-Regular.ttf", :exist?
        end
      end

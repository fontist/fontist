module Fontist
  module Formulas
    class HindSiliguriFont < FontFormula
      FULLNAME = "Hind Siliguri".freeze
      CLEANNAME = "HindSiliguri".freeze

      desc FULLNAME
      homepage "https://github.com/itfoundry/hind-siliguri"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/HindSiliguri-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/HindSiliguri-Light.ttf", :exist?
        end
      end

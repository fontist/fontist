module Fontist
  module Formulas
    class TenaliRamakrishnaFont < FontFormula
      FULLNAME = "Tenali Ramakrishna".freeze
      CLEANNAME = "TenaliRamakrishna".freeze

      desc FULLNAME
      homepage "adityafonts.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Tenali%20Ramakrishna"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/TenaliRamakrishna-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/TenaliRamakrishna-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class VesperLibreFont < FontFormula
      FULLNAME = "Vesper Libre".freeze
      CLEANNAME = "VesperLibre".freeze

      desc FULLNAME
      homepage "www.motaitalic.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Vesper%20Libre"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/VesperLibre-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/VesperLibre-Regular.ttf", :exist?
        end
      end

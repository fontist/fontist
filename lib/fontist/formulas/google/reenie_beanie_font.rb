module Fontist
  module Formulas
    class ReenieBeanieFont < FontFormula
      FULLNAME = "Reenie Beanie".freeze
      CLEANNAME = "ReenieBeanie".freeze

      desc FULLNAME
      homepage "http://code.google.com/webfonts"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Reenie%20Beanie"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ReenieBeanie.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ReenieBeanie.ttf", :exist?
        end
      end

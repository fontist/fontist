module Fontist
  module Formulas
    class DekkoFont < FontFormula
      FULLNAME = "Dekko".freeze
      CLEANNAME = "Dekko".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Dekko"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Dekko-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Dekko-Regular.ttf", :exist?
        end
      end

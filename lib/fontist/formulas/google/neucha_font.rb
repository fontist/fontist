module Fontist
  module Formulas
    class NeuchaFont < FontFormula
      FULLNAME = "Neucha".freeze
      CLEANNAME = "Neucha".freeze

      desc FULLNAME
      homepage "http://www.jovanny.ru/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Neucha"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Neucha.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Neucha.ttf", :exist?
        end
      end

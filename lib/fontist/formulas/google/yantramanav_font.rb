module Fontist
  module Formulas
    class YantramanavFont < FontFormula
      FULLNAME = "Yantramanav".freeze
      CLEANNAME = "Yantramanav".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Yantramanav"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Yantramanav-Thin.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Yantramanav-Thin.ttf", :exist?
        end
      end

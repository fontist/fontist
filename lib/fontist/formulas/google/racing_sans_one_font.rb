module Fontist
  module Formulas
    class RacingSansOneFont < FontFormula
      FULLNAME = "Racing Sans One".freeze
      CLEANNAME = "RacingSansOne".freeze

      desc FULLNAME
      homepage "www.impallari.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Racing%20Sans%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/RacingSansOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/RacingSansOne-Regular.ttf", :exist?
        end
      end

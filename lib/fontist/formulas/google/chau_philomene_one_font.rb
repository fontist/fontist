module Fontist
  module Formulas
    class ChauPhilomeneOneFont < FontFormula
      FULLNAME = "Chau Philomene One".freeze
      CLEANNAME = "ChauPhilomeneOne".freeze

      desc FULLNAME
      homepage "www.tipotype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Chau%20Philomene%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ChauPhilomeneOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ChauPhilomeneOne-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        Copyright (c) 2010-2012, TipoType (produccion.taller@gmail.com www.tipotype.com), with Reserved Font Name "Chau Philomene"

module Fontist
  module Formulas
    class NewsCycleFont < FontFormula
      FULLNAME = "News Cycle".freeze
      CLEANNAME = "NewsCycle".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=News%20Cycle"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/NewsCycle-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/NewsCycle-Regular.ttf", :exist?
        end
      end

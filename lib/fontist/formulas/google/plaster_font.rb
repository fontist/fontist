module Fontist
  module Formulas
    class PlasterFont < FontFormula
      FULLNAME = "Plaster".freeze
      CLEANNAME = "Plaster".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Plaster"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Plaster-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Plaster-Regular.ttf", :exist?
        end
      end

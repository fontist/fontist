module Fontist
  module Formulas
    class KeniaFont < FontFormula
      FULLNAME = "Kenia".freeze
      CLEANNAME = "Kenia".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Kenia"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Kenia-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Kenia-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class EkMuktaFont < FontFormula
      FULLNAME = "Ek Mukta".freeze
      CLEANNAME = "EkMukta".freeze

      desc FULLNAME
      homepage "www.ektype.in"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ek%20Mukta"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/EkMukta-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/EkMukta-ExtraLight.ttf", :exist?
        end
      end

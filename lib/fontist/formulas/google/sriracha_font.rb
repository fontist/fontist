module Fontist
  module Formulas
    class SrirachaFont < FontFormula
      FULLNAME = "Sriracha".freeze
      CLEANNAME = "Sriracha".freeze

      desc FULLNAME
      homepage "www.katatrad.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Sriracha"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Sriracha-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Sriracha-Regular.ttf", :exist?
        end
      end

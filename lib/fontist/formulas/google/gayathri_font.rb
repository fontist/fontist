module Fontist
  module Formulas
    class GayathriFont < FontFormula
      FULLNAME = "Gayathri".freeze
      CLEANNAME = "Gayathri".freeze

      desc FULLNAME
      homepage "https://smc.org.in"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Gayathri"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Gayathri-Thin.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Gayathri-Thin.ttf", :exist?
        end
      end

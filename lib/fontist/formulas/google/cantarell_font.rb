module Fontist
  module Formulas
    class CantarellFont < FontFormula
      FULLNAME = "Cantarell".freeze
      CLEANNAME = "Cantarell".freeze

      desc FULLNAME
      homepage "http://abattis.org"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Cantarell-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Cantarell-Regular.ttf", :exist?
        end
      end

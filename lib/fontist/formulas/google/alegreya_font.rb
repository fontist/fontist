module Fontist
  module Formulas
    class AlegreyaFont < FontFormula
      FULLNAME = "Alegreya".freeze
      CLEANNAME = "Alegreya".freeze

      desc FULLNAME
      homepage "http://www.huertatipografica.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Alegreya"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Alegreya-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Alegreya-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class RubikFont < FontFormula
      FULLNAME = "Rubik".freeze
      CLEANNAME = "Rubik".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Rubik[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Rubik[wght].ttf", :exist?
        end
      end

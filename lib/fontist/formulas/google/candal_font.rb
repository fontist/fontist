module Fontist
  module Formulas
    class CandalFont < FontFormula
      FULLNAME = "Candal".freeze
      CLEANNAME = "Candal".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Candal"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Candal.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Candal.ttf", :exist?
        end
      end

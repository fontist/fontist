module Fontist
  module Formulas
    class NotoSerifFont < FontFormula
      FULLNAME = "Noto Serif".freeze
      CLEANNAME = "NotoSerif".freeze

      desc FULLNAME
      homepage "http://code.google.com/p/noto/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Noto%20Serif"
        sha256 "caa6744e3c28754156a294332433ed0e559b5e20a214b56f20f5c8eb5ea078a3"
      end
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/NotoSerif-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/NotoSerif-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class PeddanaFont < FontFormula
      FULLNAME = "Peddana".freeze
      CLEANNAME = "Peddana".freeze

      desc FULLNAME
      homepage "Andhrapradesh Society for Knowledge Networks"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Peddana"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Peddana-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Peddana-Regular.ttf", :exist?
        end
      end

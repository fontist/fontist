module Fontist
  module Formulas
    class BigShouldersDisplayFont < FontFormula
      FULLNAME = "Big Shoulders Display".freeze
      CLEANNAME = "BigShouldersDisplay".freeze

      desc FULLNAME
      homepage "http://xotype.co"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Big%20Shoulders%20Display"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/BigShouldersDisplay-Thin.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/BigShouldersDisplay-Thin.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class DMMonoFont < FontFormula
      FULLNAME = "DM Mono".freeze
      CLEANNAME = "DMMono".freeze

      desc FULLNAME
      homepage "https://www.colophon-foundry.org"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/DMMono-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/DMMono-Light.ttf", :exist?
        end
      end

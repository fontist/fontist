module Fontist
  module Formulas
    class ShadowsIntoLightTwoFont < FontFormula
      FULLNAME = "Shadows Into Light Two".freeze
      CLEANNAME = "ShadowsIntoLightTwo".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Shadows%20Into%20Light%20Two"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ShadowsIntoLightTwo-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ShadowsIntoLightTwo-Regular.ttf", :exist?
        end
      end

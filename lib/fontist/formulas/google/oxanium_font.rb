module Fontist
  module Formulas
    class OxaniumFont < FontFormula
      FULLNAME = "Oxanium".freeze
      CLEANNAME = "Oxanium".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Oxanium"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Oxanium-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Oxanium-ExtraLight.ttf", :exist?
        end
      end

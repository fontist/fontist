module Fontist
  module Formulas
    class AlmendraSCFont < FontFormula
      FULLNAME = "Almendra SC".freeze
      CLEANNAME = "AlmendraSC".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Almendra%20SC"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/AlmendraSC-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/AlmendraSC-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class ShareTechFont < FontFormula
      FULLNAME = "Share Tech".freeze
      CLEANNAME = "ShareTech".freeze

      desc FULLNAME
      homepage "http://www.carrois.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Share%20Tech"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ShareTech-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ShareTech-Regular.ttf", :exist?
        end
      end

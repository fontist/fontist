module Fontist
  module Formulas
    class BangersFont < FontFormula
      FULLNAME = "Bangers".freeze
      CLEANNAME = "Bangers".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Bangers-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Bangers-Regular.ttf", :exist?
        end
      end

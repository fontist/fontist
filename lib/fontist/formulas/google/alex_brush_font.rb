module Fontist
  module Formulas
    class AlexBrushFont < FontFormula
      FULLNAME = "Alex Brush".freeze
      CLEANNAME = "AlexBrush".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Alex%20Brush"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/AlexBrush-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/AlexBrush-Regular.ttf", :exist?
        end
      end

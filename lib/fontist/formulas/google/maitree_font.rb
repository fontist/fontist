module Fontist
  module Formulas
    class MaitreeFont < FontFormula
      FULLNAME = "Maitree".freeze
      CLEANNAME = "Maitree".freeze

      desc FULLNAME
      homepage "www.cadsondemak.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Maitree"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Maitree-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Maitree-ExtraLight.ttf", :exist?
        end
      end

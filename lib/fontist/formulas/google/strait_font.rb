module Fontist
  module Formulas
    class StraitFont < FontFormula
      FULLNAME = "Strait".freeze
      CLEANNAME = "Strait".freeze

      desc FULLNAME
      homepage "http://www.tipo.net.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Strait"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Strait-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Strait-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class PublicSansFont < FontFormula
      FULLNAME = "Public Sans".freeze
      CLEANNAME = "PublicSans".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Public%20Sans"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PublicSans[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PublicSans[wght].ttf", :exist?
        end
      end

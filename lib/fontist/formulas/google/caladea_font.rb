module Fontist
  module Formulas
    class CaladeaFont < FontFormula
      FULLNAME = "Caladea".freeze
      CLEANNAME = "Caladea".freeze

      desc FULLNAME
      homepage "http://www.huertatipografica.com.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Caladea"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Caladea-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Caladea-Regular.ttf", :exist?
        end
      end

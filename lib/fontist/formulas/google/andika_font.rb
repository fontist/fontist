module Fontist
  module Formulas
    class AndikaFont < FontFormula
      FULLNAME = "Andika".freeze
      CLEANNAME = "Andika".freeze

      desc FULLNAME
      homepage "http://scripts.sil.org"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Andika"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Andika-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Andika-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        Copyright (c) 2004-2011, SIL International (http://scripts.sil.org),

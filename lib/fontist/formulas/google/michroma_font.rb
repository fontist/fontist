module Fontist
  module Formulas
    class MichromaFont < FontFormula
      FULLNAME = "Michroma".freeze
      CLEANNAME = "Michroma".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Michroma"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Michroma.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Michroma.ttf", :exist?
        end
      end

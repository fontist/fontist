module Fontist
  module Formulas
    class VollkornSCFont < FontFormula
      FULLNAME = "Vollkorn SC".freeze
      CLEANNAME = "VollkornSC".freeze

      desc FULLNAME
      homepage "http://vollkorn-typeface.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Vollkorn%20SC"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/VollkornSC-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/VollkornSC-Regular.ttf", :exist?
        end
      end

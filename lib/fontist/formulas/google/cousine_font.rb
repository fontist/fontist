module Fontist
  module Formulas
    class CousineFont < FontFormula
      FULLNAME = "Cousine".freeze
      CLEANNAME = "Cousine".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Cousine-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Cousine-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class CarterOneFont < FontFormula
      FULLNAME = "Carter One".freeze
      CLEANNAME = "CarterOne".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Carter%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/CarterOne.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/CarterOne.ttf", :exist?
        end
      end

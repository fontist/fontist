module Fontist
  module Formulas
    class OranienbaumFont < FontFormula
      FULLNAME = "Oranienbaum".freeze
      CLEANNAME = "Oranienbaum".freeze

      desc FULLNAME
      homepage "http://jovanny.ru/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Oranienbaum"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Oranienbaum-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Oranienbaum-Regular.ttf", :exist?
        end
      end

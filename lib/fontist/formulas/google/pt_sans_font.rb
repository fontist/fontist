module Fontist
  module Formulas
    class PTSansFont < FontFormula
      FULLNAME = "PT Sans".freeze
      CLEANNAME = "PTSans".freeze

      desc FULLNAME
      homepage "http://www.paratype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=PT%20Sans"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PT_Sans-Web-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PT_Sans-Web-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class EagleLakeFont < FontFormula
      FULLNAME = "Eagle Lake".freeze
      CLEANNAME = "EagleLake".freeze

      desc FULLNAME
      homepage "http://www.astigmatic.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Eagle%20Lake"
...
Font Name \"Eagle Lake\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/EagleLake-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/EagleLake-Regular.ttf", :exist?
        end
      end

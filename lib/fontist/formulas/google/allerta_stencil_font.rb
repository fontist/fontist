module Fontist
  module Formulas
    class AllertaStencilFont < FontFormula
      FULLNAME = "Allerta Stencil".freeze
      CLEANNAME = "AllertaStencil".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Allerta%20Stencil"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/AllertaStencil-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/AllertaStencil-Regular.ttf", :exist?
        end
      end

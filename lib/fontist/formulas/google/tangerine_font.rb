module Fontist
  module Formulas
    class TangerineFont < FontFormula
      FULLNAME = "Tangerine".freeze
      CLEANNAME = "Tangerine".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Tangerine"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Tangerine-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Tangerine-Regular.ttf", :exist?
        end
      end

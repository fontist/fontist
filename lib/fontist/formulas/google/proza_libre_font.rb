module Fontist
  module Formulas
    class ProzaLibreFont < FontFormula
      FULLNAME = "Proza Libre".freeze
      CLEANNAME = "ProzaLibre".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Proza%20Libre"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ProzaLibre-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ProzaLibre-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class GildaDisplayFont < FontFormula
      FULLNAME = "Gilda Display".freeze
      CLEANNAME = "GildaDisplay".freeze

      desc FULLNAME
      homepage "http://www.tipo.net.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Gilda%20Display"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/GildaDisplay-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/GildaDisplay-Regular.ttf", :exist?
        end
      end

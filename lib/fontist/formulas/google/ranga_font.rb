module Fontist
  module Formulas
    class RangaFont < FontFormula
      FULLNAME = "Ranga".freeze
      CLEANNAME = "Ranga".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ranga"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Ranga-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Ranga-Regular.ttf", :exist?
        end
      end

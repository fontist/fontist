module Fontist
  module Formulas
    class CalistogaFont < FontFormula
      FULLNAME = "Calistoga".freeze
      CLEANNAME = "Calistoga".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Calistoga"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Calistoga-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Calistoga-Regular.ttf", :exist?
        end
      end

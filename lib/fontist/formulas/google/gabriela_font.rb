module Fontist
  module Formulas
    class GabrielaFont < FontFormula
      FULLNAME = "Gabriela".freeze
      CLEANNAME = "Gabriela".freeze

      desc FULLNAME
      homepage "http://www.tipo.net.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Gabriela"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Gabriela-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Gabriela-Regular.ttf", :exist?
        end
      end

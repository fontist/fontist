module Fontist
  module Formulas
    class MallannaFont < FontFormula
      FULLNAME = "Mallanna".freeze
      CLEANNAME = "Mallanna".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Mallanna"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Mallanna-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Mallanna-Regular.ttf", :exist?
        end
      end

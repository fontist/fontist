module Fontist
  module Formulas
    class GeoFont < FontFormula
      FULLNAME = "Geo".freeze
      CLEANNAME = "Geo".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Geo"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Geo-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Geo-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class BenchNineFont < FontFormula
      FULLNAME = "BenchNine".freeze
      CLEANNAME = "BenchNine".freeze

      desc FULLNAME
      homepage "newtypography.co.uk"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=BenchNine"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/BenchNine-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/BenchNine-Light.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class BalooDa2Font < FontFormula
      FULLNAME = "Baloo Da 2".freeze
      CLEANNAME = "BalooDa2".freeze

      desc FULLNAME
      homepage "www.ektype.in"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Baloo%20Da%202"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/BalooDa2-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/BalooDa2-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class OldenburgFont < FontFormula
      FULLNAME = "Oldenburg".freeze
      CLEANNAME = "Oldenburg".freeze

      desc FULLNAME
      homepage "sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Oldenburg"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Oldenburg-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Oldenburg-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class CharmonmanFont < FontFormula
      FULLNAME = "Charmonman".freeze
      CLEANNAME = "Charmonman".freeze

      desc FULLNAME
      homepage "http://www.cadsondemak.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Charmonman"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Charmonman-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Charmonman-Regular.ttf", :exist?
        end
      end

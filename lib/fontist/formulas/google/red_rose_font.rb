module Fontist
  module Formulas
    class RedRoseFont < FontFormula
      FULLNAME = "Red Rose".freeze
      CLEANNAME = "RedRose".freeze

      desc FULLNAME
      homepage "http://magictype.in"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Red%20Rose"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/RedRose-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/RedRose-Light.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class KarlaFont < FontFormula
      FULLNAME = "Karla".freeze
      CLEANNAME = "Karla".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Karla"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Karla[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Karla[wght].ttf", :exist?
        end
      end

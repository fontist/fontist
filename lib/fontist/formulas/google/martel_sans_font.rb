module Fontist
  module Formulas
    class MartelSansFont < FontFormula
      FULLNAME = "Martel Sans".freeze
      CLEANNAME = "MartelSans".freeze

      desc FULLNAME
      homepage "http://www.typeoff.de"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Martel%20Sans"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/MartelSans-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/MartelSans-ExtraLight.ttf", :exist?
        end
      end

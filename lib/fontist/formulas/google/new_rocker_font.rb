module Fontist
  module Formulas
    class NewRockerFont < FontFormula
      FULLNAME = "New Rocker".freeze
      CLEANNAME = "NewRocker".freeze

      desc FULLNAME
      homepage "www.impallari.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=New%20Rocker"
...
With Blackletter, Tattoo and Heavy Metal logos as inspiration.",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/NewRocker-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/NewRocker-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class CherrySwashFont < FontFormula
      FULLNAME = "Cherry Swash".freeze
      CLEANNAME = "CherrySwash".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Cherry%20Swash"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/CherrySwash-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/CherrySwash-Regular.ttf", :exist?
        end
      end

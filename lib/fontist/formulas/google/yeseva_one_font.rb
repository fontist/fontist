module Fontist
  module Formulas
    class YesevaOneFont < FontFormula
      FULLNAME = "Yeseva One".freeze
      CLEANNAME = "YesevaOne".freeze

      desc FULLNAME
      homepage "http://jovanny.ru"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Yeseva%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/YesevaOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/YesevaOne-Regular.ttf", :exist?
        end
      end

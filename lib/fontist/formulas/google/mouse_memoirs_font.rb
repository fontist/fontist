module Fontist
  module Formulas
    class MouseMemoirsFont < FontFormula
      FULLNAME = "Mouse Memoirs".freeze
      CLEANNAME = "MouseMemoirs".freeze

      desc FULLNAME
      homepage "http://www.astigmatic.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Mouse%20Memoirs"
...
Font Name \"Mouse Memoirs\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/MouseMemoirs-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/MouseMemoirs-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class InderFont < FontFormula
      FULLNAME = "Inder".freeze
      CLEANNAME = "Inder".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Inder"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Inder-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Inder-Regular.ttf", :exist?
        end
      end

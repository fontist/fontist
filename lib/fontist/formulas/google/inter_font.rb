module Fontist
  module Formulas
    class InterFont < FontFormula
      FULLNAME = "Inter".freeze
      CLEANNAME = "Inter".freeze

      desc FULLNAME
      homepage "https://rsms.me/"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Inter[slnt,wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Inter[slnt,wght].ttf", :exist?
        end
      end

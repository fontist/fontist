module Fontist
  module Formulas
    class OdorMeanCheyFont < FontFormula
      FULLNAME = "Odor Mean Chey".freeze
      CLEANNAME = "OdorMeanChey".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Odor%20Mean%20Chey"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/OdorMeanChey.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/OdorMeanChey.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        ...
        with Reserved Font Name "Odor Mean Chey".

module Fontist
  module Formulas
    class ClickerScriptFont < FontFormula
      FULLNAME = "Clicker Script".freeze
      CLEANNAME = "ClickerScript".freeze

      desc FULLNAME
      homepage "http://www.astigmatic.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Clicker%20Script"
...
Font Name \"Clicker Script\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ClickerScript-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ClickerScript-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        Copyright (c) 2012 by Brian J. Bonislawsky and Jim Lyles DBA Astigmatic (AOETI) (astigma@astigmatic.com), with Reserved Font Name "Mouse Memoirs"

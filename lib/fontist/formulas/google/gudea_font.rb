module Fontist
  module Formulas
    class GudeaFont < FontFormula
      FULLNAME = "Gudea".freeze
      CLEANNAME = "Gudea".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Gudea"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Gudea-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Gudea-Regular.ttf", :exist?
        end
      end

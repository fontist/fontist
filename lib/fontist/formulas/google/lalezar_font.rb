module Fontist
  module Formulas
    class LalezarFont < FontFormula
      FULLNAME = "Lalezar".freeze
      CLEANNAME = "Lalezar".freeze

      desc FULLNAME
      homepage "http://www.borna.design"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Lalezar"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Lalezar-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Lalezar-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class CodystarFont < FontFormula
      FULLNAME = "Codystar".freeze
      CLEANNAME = "Codystar".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Codystar-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Codystar-Light.ttf", :exist?
        end
      end

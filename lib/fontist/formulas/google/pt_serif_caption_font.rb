module Fontist
  module Formulas
    class PTSerifCaptionFont < FontFormula
      FULLNAME = "PT Serif Caption".freeze
      CLEANNAME = "PTSerifCaption".freeze

      desc FULLNAME
      homepage "http://www.paratype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=PT%20Serif%20Caption"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PT_Serif-Caption-Web-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PT_Serif-Caption-Web-Regular.ttf", :exist?
        end
      end

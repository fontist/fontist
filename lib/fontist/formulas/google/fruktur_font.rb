module Fontist
  module Formulas
    class FrukturFont < FontFormula
      FULLNAME = "Fruktur".freeze
      CLEANNAME = "Fruktur".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Fruktur"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Fruktur-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Fruktur-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        Copyright (c) 2013 by Sorkin Type Co (www.sorkintype.com),
        with Reserved Font Name "Fruktur".

module Fontist
  module Formulas
    class ConvergenceFont < FontFormula
      FULLNAME = "Convergence".freeze
      CLEANNAME = "Convergence".freeze

      desc FULLNAME
      homepage "http://www.johnvargasbeltran.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Convergence"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Convergence-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Convergence-Regular.ttf", :exist?
        end
      end

  ...
  module Formulas
    class BeVietnamFont < FontFormula
      ...
      provides_font(FULLNAME, match_styles_from_file: {
        "Thin" => "BeVietnam-Thin.ttf",
        "ThinItalic" => "BeVietnam-ThinItalic.ttf",
        "Light" => "BeVietnam-Light.ttf",
        "LightItalic" => "BeVietnam-LightItalic.ttf",
        "Regular" => "BeVietnam-Regular.ttf",
        "Italic" => "BeVietnam-Italic.ttf",
        "Medium" => "BeVietnam-Medium.ttf",
        "MediumItalic" => "BeVietnam-MediumItalic.ttf",
        "SemiBold" => "BeVietnam-SemiBold.ttf",
        "SemiBoldItalic" => "BeVietnam-SemiBoldItalic.ttf",
        "Bold" => "BeVietnam-Bold.ttf",
        "BoldItalic" => "BeVietnam-BoldItalic.ttf",
        "ExtraBold" => "BeVietnam-ExtraBold.ttf",
        "ExtraBoldItalic" => "BeVietnam-ExtraBoldItalic.ttf",
      })

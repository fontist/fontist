module Fontist
  module Formulas
    class AndadaFont < FontFormula
      FULLNAME = "Andada".freeze
      CLEANNAME = "Andada".freeze

      desc FULLNAME
      homepage "www.huertatipografica.com.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Andada"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Andada-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Andada-Regular.ttf", :exist?
        end
      end

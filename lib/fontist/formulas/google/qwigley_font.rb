module Fontist
  module Formulas
    class QwigleyFont < FontFormula
      FULLNAME = "Qwigley".freeze
      CLEANNAME = "Qwigley".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Qwigley"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Qwigley-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Qwigley-Regular.ttf", :exist?
        end
      end

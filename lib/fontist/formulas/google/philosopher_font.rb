module Fontist
  module Formulas
    class PhilosopherFont < FontFormula
      FULLNAME = "Philosopher".freeze
      CLEANNAME = "Philosopher".freeze

      desc FULLNAME
      homepage "http://www.jovanny.ru/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Philosopher"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Philosopher-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Philosopher-Regular.ttf", :exist?
        end
      end

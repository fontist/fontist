module Fontist
  module Formulas
    class QuanticoFont < FontFormula
      FULLNAME = "Quantico".freeze
      CLEANNAME = "Quantico".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Quantico-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Quantico-Regular.ttf", :exist?
        end
      end

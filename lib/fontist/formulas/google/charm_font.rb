module Fontist
  module Formulas
    class CharmFont < FontFormula
      FULLNAME = "Charm".freeze
      CLEANNAME = "Charm".freeze

      desc FULLNAME
      homepage "http://www.cadsondemak.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Charm"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Charm-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Charm-Regular.ttf", :exist?
        end
      end

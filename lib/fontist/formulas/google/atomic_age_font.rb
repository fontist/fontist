module Fontist
  module Formulas
    class AtomicAgeFont < FontFormula
      FULLNAME = "Atomic Age".freeze
      CLEANNAME = "AtomicAge".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Atomic%20Age"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/AtomicAge-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/AtomicAge-Regular.ttf", :exist?
        end
      end

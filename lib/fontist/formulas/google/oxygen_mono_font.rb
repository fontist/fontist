module Fontist
  module Formulas
    class OxygenMonoFont < FontFormula
      FULLNAME = "Oxygen Mono".freeze
      CLEANNAME = "OxygenMono".freeze

      desc FULLNAME
      homepage "newtypography.co.uk"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Oxygen%20Mono"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/OxygenMono-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/OxygenMono-Regular.ttf", :exist?
        end
      end

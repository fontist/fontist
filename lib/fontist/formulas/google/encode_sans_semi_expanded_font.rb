module Fontist
  module Formulas
    class EncodeSansSemiExpandedFont < FontFormula
      FULLNAME = "Encode Sans Semi Expanded".freeze
      CLEANNAME = "EncodeSansSemiExpanded".freeze

      desc FULLNAME
      homepage "http://www.impallari.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Encode%20Sans%20Semi%20Expanded"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/EncodeSansSemiExpanded-Thin.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/EncodeSansSemiExpanded-Thin.ttf", :exist?
        end
      end

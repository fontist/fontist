module Fontist
  module Formulas
    class CairoFont < FontFormula
      FULLNAME = "Cairo".freeze
      CLEANNAME = "Cairo".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Cairo-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Cairo-ExtraLight.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class SintonyFont < FontFormula
      FULLNAME = "Sintony".freeze
      CLEANNAME = "Sintony".freeze

      desc FULLNAME
      homepage "http://www.tipo.net.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Sintony"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Sintony-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Sintony-Regular.ttf", :exist?
        end
      end

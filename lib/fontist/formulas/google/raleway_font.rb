module Fontist
  module Formulas
    class RalewayFont < FontFormula
      FULLNAME = "Raleway".freeze
      CLEANNAME = "Raleway".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Raleway[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Raleway[wght].ttf", :exist?
        end
      end

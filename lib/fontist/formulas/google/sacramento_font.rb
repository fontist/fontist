module Fontist
  module Formulas
    class SacramentoFont < FontFormula
      FULLNAME = "Sacramento".freeze
      CLEANNAME = "Sacramento".freeze

      desc FULLNAME
      homepage "http://www.astigmatic.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Sacramento"
...
Font Name \"Sacramento\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Sacramento-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Sacramento-Regular.ttf", :exist?
        end
      end

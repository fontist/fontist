module Fontist
  module Formulas
    class WarnesFont < FontFormula
      FULLNAME = "Warnes".freeze
      CLEANNAME = "Warnes".freeze

      desc FULLNAME
      homepage "www.tipo.net.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Warnes"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Warnes-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Warnes-Regular.ttf", :exist?
        end
      end

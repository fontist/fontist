module Fontist
  module Formulas
    class NanumGothicCodingFont < FontFormula
      FULLNAME = "Nanum Gothic Coding".freeze
      CLEANNAME = "NanumGothicCoding".freeze

      desc FULLNAME
      homepage "http://www.nhncorp.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Nanum%20Gothic%20Coding"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/NanumGothicCoding-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/NanumGothicCoding-Regular.ttf", :exist?
        end
      end

      copyright "Copyright © 2009 NHN Corporation. All rights reserved. Font designed by Sandoll Communications Inc."
      license_url "http://dev.naver.com/wiki/nanumfont/index.php/OpenFontLicense"

module Fontist
  module Formulas
    class MadaFont < FontFormula
      FULLNAME = "Mada".freeze
      CLEANNAME = "Mada".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Mada"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Mada-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Mada-ExtraLight.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class LakkiReddyFont < FontFormula
      FULLNAME = "Lakki Reddy".freeze
      CLEANNAME = "LakkiReddy".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Lakki%20Reddy"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/LakkiReddy-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/LakkiReddy-Regular.ttf", :exist?
        end
      end

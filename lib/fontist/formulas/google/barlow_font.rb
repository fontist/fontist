  ...
  module Formulas
    class BarlowFont < FontFormula
      ...
      provides_font(FULLNAME, match_styles_from_file: {
        "Thin" => "Barlow-Thin.ttf",
        "ThinItalic" => "Barlow-ThinItalic.ttf",
        "ExtraLight" => "Barlow-ExtraLight.ttf",
        "ExtraLightItalic" => "Barlow-ExtraLightItalic.ttf",
        "Light" => "Barlow-Light.ttf",
        "LightItalic" => "Barlow-LightItalic.ttf",
        ...
        "SemiBoldItalic" => "Barlow-SemiBoldItalic.ttf",

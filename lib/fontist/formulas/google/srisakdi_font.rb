module Fontist
  module Formulas
    class SrisakdiFont < FontFormula
      FULLNAME = "Srisakdi".freeze
      CLEANNAME = "Srisakdi".freeze

      desc FULLNAME
      homepage "http://www.cadsondemak.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Srisakdi"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Srisakdi-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Srisakdi-Regular.ttf", :exist?
        end
      end

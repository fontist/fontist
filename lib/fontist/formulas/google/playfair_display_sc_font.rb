module Fontist
  module Formulas
    class PlayfairDisplaySCFont < FontFormula
      FULLNAME = "Playfair Display SC".freeze
      CLEANNAME = "PlayfairDisplaySC".freeze

      desc FULLNAME
      homepage "http://www.forthehearts.net"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Playfair%20Display%20SC"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PlayfairDisplaySC-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PlayfairDisplaySC-Regular.ttf", :exist?
        end
      end

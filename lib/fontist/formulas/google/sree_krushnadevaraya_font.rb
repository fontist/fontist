module Fontist
  module Formulas
    class SreeKrushnadevarayaFont < FontFormula
      FULLNAME = "Sree Krushnadevaraya".freeze
      CLEANNAME = "SreeKrushnadevaraya".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Sree%20Krushnadevaraya"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/SreeKrushnadevaraya-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/SreeKrushnadevaraya-Regular.ttf", :exist?
        end
      end

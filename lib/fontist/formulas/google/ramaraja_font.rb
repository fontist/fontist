module Fontist
  module Formulas
    class RamarajaFont < FontFormula
      FULLNAME = "Ramaraja".freeze
      CLEANNAME = "Ramaraja".freeze

      desc FULLNAME
      homepage "adityafonts.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ramaraja"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Ramaraja-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Ramaraja-Regular.ttf", :exist?
        end
      end

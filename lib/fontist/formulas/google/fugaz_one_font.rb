module Fontist
  module Formulas
    class FugazOneFont < FontFormula
      FULLNAME = "Fugaz One".freeze
      CLEANNAME = "FugazOne".freeze

      desc FULLNAME
      homepage "www.latinotype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Fugaz%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/FugazOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/FugazOne-Regular.ttf", :exist?
        end
      end

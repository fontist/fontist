module Fontist
  module Formulas
    class BayonFont < FontFormula
      FULLNAME = "Bayon".freeze
      CLEANNAME = "Bayon".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Bayon"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Bayon-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Bayon-Regular.ttf", :exist?
        end
      end

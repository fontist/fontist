module Fontist
  module Formulas
    class SairaFont < FontFormula
      FULLNAME = "Saira".freeze
      CLEANNAME = "Saira".freeze

      desc FULLNAME
      homepage "http://www.omnibus-type.com/fonts/chivo.php"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Saira"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Saira-Thin.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Saira-Thin.ttf", :exist?
        end
      end

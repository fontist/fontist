module Fontist
  module Formulas
    class BellotaFont < FontFormula
      FULLNAME = "Bellota".freeze
      CLEANNAME = "Bellota".freeze

      desc FULLNAME
      homepage "http://www.pixilate.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Bellota"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Bellota-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Bellota-Light.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class DevonshireFont < FontFormula
      FULLNAME = "Devonshire".freeze
      CLEANNAME = "Devonshire".freeze

      desc FULLNAME
      homepage "http://www.astigmatic.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Devonshire"
...
Font Name \"Devonshire\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Devonshire-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Devonshire-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        ...
        (astigma@astigmatic.com), with Reserved Font Name "Devonshire"

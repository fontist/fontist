module Fontist
  module Formulas
    class PathwayGothicOneFont < FontFormula
      FULLNAME = "Pathway Gothic One".freeze
      CLEANNAME = "PathwayGothicOne".freeze

      desc FULLNAME
      homepage "http://www.tipo.net.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Pathway%20Gothic%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PathwayGothicOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PathwayGothicOne-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class GirassolFont < FontFormula
      FULLNAME = "Girassol".freeze
      CLEANNAME = "Girassol".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Girassol"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Girassol-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Girassol-Regular.ttf", :exist?
        end
      end

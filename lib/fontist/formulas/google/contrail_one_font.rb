module Fontist
  module Formulas
    class ContrailOneFont < FontFormula
      FULLNAME = "Contrail One".freeze
      CLEANNAME = "ContrailOne".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Contrail%20One"
...
with Reserved Font Names \"Contrail\" and \"Contrail One\".",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ContrailOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ContrailOne-Regular.ttf", :exist?
        end
      end

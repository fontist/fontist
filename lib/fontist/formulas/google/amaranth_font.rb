module Fontist
  module Formulas
    class AmaranthFont < FontFormula
      FULLNAME = "Amaranth".freeze
      CLEANNAME = "Amaranth".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Amaranth"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Amaranth-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Amaranth-Regular.ttf", :exist?
        end
      end

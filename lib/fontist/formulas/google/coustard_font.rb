module Fontist
  module Formulas
    class CoustardFont < FontFormula
      FULLNAME = "Coustard".freeze
      CLEANNAME = "Coustard".freeze
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Coustard-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Coustard-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        ...
        with Reserved Font Names "Coustard", "Coustard-Black"

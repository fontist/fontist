module Fontist
  module Formulas
    class MontserratSubrayadaFont < FontFormula
      FULLNAME = "Montserrat Subrayada".freeze
      CLEANNAME = "MontserratSubrayada".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Montserrat%20Subrayada"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/MontserratSubrayada-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/MontserratSubrayada-Regular.ttf", :exist?
        end
      end

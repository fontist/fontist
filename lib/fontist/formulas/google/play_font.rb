module Fontist
  module Formulas
    class PlayFont < FontFormula
      FULLNAME = "Play".freeze
      CLEANNAME = "Play".freeze

      desc FULLNAME
      homepage "http://www.playtype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Play"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Play-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Play-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class AladinFont < FontFormula
      FULLNAME = "Aladin".freeze
      CLEANNAME = "Aladin".freeze

      desc FULLNAME
      homepage "http://www.sudtipos.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Aladin"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Aladin-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Aladin-Regular.ttf", :exist?
        end
      end

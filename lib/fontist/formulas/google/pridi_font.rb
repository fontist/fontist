module Fontist
  module Formulas
    class PridiFont < FontFormula
      FULLNAME = "Pridi".freeze
      CLEANNAME = "Pridi".freeze

      desc FULLNAME
      homepage "www.cadsondemak.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Pridi"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Pridi-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Pridi-ExtraLight.ttf", :exist?
        end
      end

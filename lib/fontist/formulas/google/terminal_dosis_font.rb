module Fontist
  module Formulas
    class TerminalDosisFont < FontFormula
      FULLNAME = "Terminal Dosis".freeze
      CLEANNAME = "TerminalDosis".freeze

      desc FULLNAME
      homepage "www.impallari.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Terminal%20Dosis"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/TerminalDosis-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/TerminalDosis-ExtraLight.ttf", :exist?
        end
      end

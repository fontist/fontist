module Fontist
  module Formulas
    class CreteRoundFont < FontFormula
      FULLNAME = "Crete Round".freeze
      CLEANNAME = "CreteRound".freeze

      desc FULLNAME
      homepage "www.type-together.com/Crete"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Crete%20Round"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/CreteRound-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/CreteRound-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class CantataOneFont < FontFormula
      FULLNAME = "Cantata One".freeze
      CLEANNAME = "CantataOne".freeze

      desc FULLNAME
      homepage "http://www.sorkintype.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Cantata%20One"
...
This Font Software is licensed under the SIL Open Font License, Version 1.1. This license is copied below, and is also available with a FAQ at: http://scripts.sil.org/OFL",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/CantataOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/CantataOne-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class SignikaNegativeFont < FontFormula
      FULLNAME = "Signika Negative".freeze
      CLEANNAME = "SignikaNegative".freeze

      desc FULLNAME
      homepage "www.ancymonic.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Signika%20Negative"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/SignikaNegative-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/SignikaNegative-Light.ttf", :exist?
        end
      end

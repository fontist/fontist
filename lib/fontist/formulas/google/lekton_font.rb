module Fontist
  module Formulas
    class LektonFont < FontFormula
      FULLNAME = "Lekton".freeze
      CLEANNAME = "Lekton".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Lekton"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Lekton-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Lekton-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class IMFellEnglishSCFont < FontFormula
      FULLNAME = "IM Fell English SC".freeze
      CLEANNAME = "IMFellEnglishSC".freeze

      desc FULLNAME
      homepage "www.iginomarini.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=IM%20Fell%20English%20SC"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/IMFeENsc28P.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/IMFeENsc28P.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class RaviPrakashFont < FontFormula
      FULLNAME = "Ravi Prakash".freeze
      CLEANNAME = "RaviPrakash".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ravi%20Prakash"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/RaviPrakash-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/RaviPrakash-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class NeutonFont < FontFormula
      FULLNAME = "Neuton".freeze
      CLEANNAME = "Neuton".freeze

      desc FULLNAME
      homepage "http://www.21326.info/"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Neuton-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Neuton-ExtraLight.ttf", :exist?
        end
      end

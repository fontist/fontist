module Fontist
  module Formulas
    class PTSansNarrowFont < FontFormula
      FULLNAME = "PT Sans Narrow".freeze
      CLEANNAME = "PTSansNarrow".freeze

      desc FULLNAME
      homepage "http://www.paratype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=PT%20Sans%20Narrow"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PT_Sans-Narrow-Web-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PT_Sans-Narrow-Web-Regular.ttf", :exist?
        end
      end

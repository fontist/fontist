module Fontist
  module Formulas
    class RanchersFont < FontFormula
      FULLNAME = "Ranchers".freeze
      CLEANNAME = "Ranchers".freeze

      desc FULLNAME
      homepage "www.impallari.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ranchers"
...
It's great for big posters and fun headlines. Use it bigger than 40px for maximum effect.",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Ranchers-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Ranchers-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        Copyright (c) 2012, Pablo Impallari (www.impallari.com|impallari@gmail.com), Copyright (c) 2012, Brenda Gallo. (gbrenda1987@gmail.com), with Reserved Font Name Ranchers.

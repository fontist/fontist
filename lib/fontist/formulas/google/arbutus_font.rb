module Fontist
  module Formulas
    class ArbutusFont < FontFormula
      FULLNAME = "Arbutus".freeze
      CLEANNAME = "Arbutus".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Arbutus"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Arbutus-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Arbutus-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class CaudexFont < FontFormula
      FULLNAME = "Caudex".freeze
      CLEANNAME = "Caudex".freeze

      desc FULLNAME
      homepage "http://caudex.sf.net/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Caudex"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Caudex-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Caudex-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        Copyright (c) 2011, Hjort Nidudsson (http://caudex.sf.net),
        with Reserved Font Name Caudex.

module Fontist
  module Formulas
    class PurplePurseFont < FontFormula
      FULLNAME = "Purple Purse".freeze
      CLEANNAME = "PurplePurse".freeze

      desc FULLNAME
      homepage "http://www.astigmatic.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Purple%20Purse"
...
Font Name \"Purple Purse\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PurplePurse-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PurplePurse-Regular.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        ...
        (astigma@astigmatic.com), with Reserved Font Name "Purple Purse"

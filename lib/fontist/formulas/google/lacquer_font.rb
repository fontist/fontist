module Fontist
  module Formulas
    class LacquerFont < FontFormula
      FULLNAME = "Lacquer".freeze
      CLEANNAME = "Lacquer".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Lacquer"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Lacquer-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Lacquer-Regular.ttf", :exist?
        end
      end

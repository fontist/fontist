module Fontist
  module Formulas
    class VarelaFont < FontFormula
      FULLNAME = "Varela".freeze
      CLEANNAME = "Varela".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Varela"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Varela-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Varela-Regular.ttf", :exist?
        end
      end

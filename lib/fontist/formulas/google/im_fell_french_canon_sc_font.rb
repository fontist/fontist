module Fontist
  module Formulas
    class IMFellFrenchCanonSCFont < FontFormula
      FULLNAME = "IM Fell French Canon SC".freeze
      CLEANNAME = "IMFellFrenchCanonSC".freeze

      desc FULLNAME
      homepage "www.iginomarini.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=IM%20Fell%20French%20Canon%20SC"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/IMFeFCsc28P.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/IMFeFCsc28P.ttf", :exist?
        end
      end

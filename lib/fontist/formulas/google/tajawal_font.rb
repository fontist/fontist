module Fontist
  module Formulas
    class TajawalFont < FontFormula
      FULLNAME = "Tajawal".freeze
      CLEANNAME = "Tajawal".freeze

      desc FULLNAME
      homepage "http://www.boutrosfonts.com"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Tajawal-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Tajawal-ExtraLight.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class NobileFont < FontFormula
      FULLNAME = "Nobile".freeze
      CLEANNAME = "Nobile".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Nobile"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Nobile-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Nobile-Regular.ttf", :exist?
        end
      end

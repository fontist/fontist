module Fontist
  module Formulas
    class MuktaVaaniFont < FontFormula
      FULLNAME = "Mukta Vaani".freeze
      CLEANNAME = "MuktaVaani".freeze

      desc FULLNAME
      homepage "www.ektype.in"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Mukta%20Vaani"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/MuktaVaani-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/MuktaVaani-ExtraLight.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class NanumBrushScriptFont < FontFormula
      FULLNAME = "Nanum Brush Script".freeze
      CLEANNAME = "NanumBrushScript".freeze

      desc FULLNAME
      homepage "http://www.nhncorp.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Nanum%20Brush%20Script"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/NanumBrushScript-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/NanumBrushScript-Regular.ttf", :exist?
        end
      end

      copyright "Copyright © 2010 NHN Corporation. All rights reserved. Font designed by Sandoll Communications Inc."
      license_url "http://www.nhncorp.com"

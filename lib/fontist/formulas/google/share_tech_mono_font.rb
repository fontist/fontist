module Fontist
  module Formulas
    class ShareTechMonoFont < FontFormula
      FULLNAME = "Share Tech Mono".freeze
      CLEANNAME = "ShareTechMono".freeze

      desc FULLNAME
      homepage "http://www.carrois.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Share%20Tech%20Mono"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/ShareTechMono-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/ShareTechMono-Regular.ttf", :exist?
        end
      end

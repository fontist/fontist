module Fontist
  module Formulas
    class KronaOneFont < FontFormula
      FULLNAME = "Krona One".freeze
      CLEANNAME = "KronaOne".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Krona%20One"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/KronaOne-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/KronaOne-Regular.ttf", :exist?
        end
      end

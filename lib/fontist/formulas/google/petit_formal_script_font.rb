module Fontist
  module Formulas
    class PetitFormalScriptFont < FontFormula
      FULLNAME = "Petit Formal Script".freeze
      CLEANNAME = "PetitFormalScript".freeze

      desc FULLNAME
      homepage "www.impallari.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Petit%20Formal%20Script"
...
with Reserved Font Name Petit Formal Script.",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/PetitFormalScript-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/PetitFormalScript-Regular.ttf", :exist?
        end
      end

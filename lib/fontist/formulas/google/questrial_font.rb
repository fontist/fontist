module Fontist
  module Formulas
    class QuestrialFont < FontFormula
      FULLNAME = "Questrial".freeze
      CLEANNAME = "Questrial".freeze

      desc FULLNAME
      homepage "https://www.laurameseguer.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Questrial"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Questrial-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Questrial-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class SuravaramFont < FontFormula
      FULLNAME = "Suravaram".freeze
      CLEANNAME = "Suravaram".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Suravaram"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Suravaram-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Suravaram-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class AlatsiFont < FontFormula
      FULLNAME = "Alatsi".freeze
      CLEANNAME = "Alatsi".freeze

      desc FULLNAME
      homepage "www.sorkintype.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Alatsi"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Alatsi-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Alatsi-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class FreehandFont < FontFormula
      FULLNAME = "Freehand".freeze
      CLEANNAME = "Freehand".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Freehand"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Freehand.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Freehand.ttf", :exist?
        end
      end
      ...
      open_license <<~TEXT
        ...
        with Reserved Font Name Freehand.

module Fontist
  module Formulas
    class DosisFont < FontFormula
      FULLNAME = "Dosis".freeze
      CLEANNAME = "Dosis".freeze

      desc FULLNAME
      homepage "http://www.impallari.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Dosis"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Dosis[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Dosis[wght].ttf", :exist?
        end
      end

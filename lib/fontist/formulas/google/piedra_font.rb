module Fontist
  module Formulas
    class PiedraFont < FontFormula
      FULLNAME = "Piedra".freeze
      CLEANNAME = "Piedra".freeze

      desc FULLNAME
      homepage "www.sudtipos.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Piedra"
...
with Reserved Font Name \"Piedra\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Piedra-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Piedra-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class LeagueScriptFont < FontFormula
      FULLNAME = "League Script".freeze
      CLEANNAME = "LeagueScript".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=League%20Script"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/LeagueScript-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/LeagueScript-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class MiriamLibreFont < FontFormula
      FULLNAME = "Miriam Libre".freeze
      CLEANNAME = "MiriamLibre".freeze

      desc FULLNAME
      homepage "http://hagilda.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Miriam%20Libre"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/MiriamLibre-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/MiriamLibre-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class KalamFont < FontFormula
      FULLNAME = "Kalam".freeze
      CLEANNAME = "Kalam".freeze

      desc FULLNAME
      homepage "http://www.indiantypefoundry.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Kalam"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Kalam-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Kalam-Light.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class VollkornFont < FontFormula
      FULLNAME = "Vollkorn".freeze
      CLEANNAME = "Vollkorn".freeze

      desc FULLNAME
      homepage "http://vollkorn-typeface.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Vollkorn"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Vollkorn[wght].ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Vollkorn[wght].ttf", :exist?
        end
      end

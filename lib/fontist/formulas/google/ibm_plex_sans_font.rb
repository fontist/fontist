  ...
  module Formulas
    class IBMPlexSansFont < FontFormula
      ...
      provides_font(FULLNAME, match_styles_from_file: {
        "Thin" => "IBMPlexSans-Thin.ttf",
        "ThinItalic" => "IBMPlexSans-ThinItalic.ttf",
        "ExtraLight" => "IBMPlexSans-ExtraLight.ttf",
        "ExtraLightItalic" => "IBMPlexSans-ExtraLightItalic.ttf",
        "Light" => "IBMPlexSans-Light.ttf",
        "LightItalic" => "IBMPlexSans-LightItalic.ttf",
        "Regular" => "IBMPlexSans-Regular.ttf",
        "Italic" => "IBMPlexSans-Italic.ttf",
        "Medium" => "IBMPlexSans-Medium.ttf",
        "MediumItalic" => "IBMPlexSans-MediumItalic.ttf",
        "SemiBold" => "IBMPlexSans-SemiBold.ttf",
        "SemiBoldItalic" => "IBMPlexSans-SemiBoldItalic.ttf",

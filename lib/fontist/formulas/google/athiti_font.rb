module Fontist
  module Formulas
    class AthitiFont < FontFormula
      FULLNAME = "Athiti".freeze
      CLEANNAME = "Athiti".freeze

      desc FULLNAME
      homepage "www.cadsondemak.com"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Athiti"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Athiti-ExtraLight.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Athiti-ExtraLight.ttf", :exist?
        end
      end

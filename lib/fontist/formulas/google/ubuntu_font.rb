module Fontist
  module Formulas
    class UbuntuFont < FontFormula
      FULLNAME = "Ubuntu".freeze
      CLEANNAME = "Ubuntu".freeze

      desc FULLNAME
      homepage "http://www.daltonmaag.com/"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ubuntu"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Ubuntu-Light.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Ubuntu-Light.ttf", :exist?
        end
      end

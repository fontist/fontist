module Fontist
  module Formulas
    class RugeBoogieFont < FontFormula
      FULLNAME = "Ruge Boogie".freeze
      CLEANNAME = "RugeBoogie".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Ruge%20Boogie"
...
with Reserved Font Name \"Ruge Boogie\"",
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/RugeBoogie-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/RugeBoogie-Regular.ttf", :exist?
        end
      end

module Fontist
  module Formulas
    class AryaFont < FontFormula
      FULLNAME = "Arya".freeze
      CLEANNAME = "Arya".freeze

      desc FULLNAME
      homepage "http://www.tipo.net.ar"

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Arya"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Arya-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Arya-Regular.ttf", :exist?
        end
      end

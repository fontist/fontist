module Fontist
  module Formulas
    class GiduguFont < FontFormula
      FULLNAME = "Gidugu".freeze
      CLEANNAME = "Gidugu".freeze

      desc FULLNAME
      homepage ""

      resource "#{CLEANNAME}.zip" do
        url "https://fonts.google.com/download?family=Gidugu"
      ...
      test do
        case platform
        when :macos
          assert_predicate "$HOME/Library/Fonts/#{CLEANNAME}/Gidugu-Regular.ttf", :exist?
        when :linux
          assert_predicate "/usr/share/fonts/truetype/#{CLEANNAME.downcase}/Gidugu-Regular.ttf", :exist?
        end
      end

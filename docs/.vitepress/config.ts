...
export default defineConfig({
  ...
  title: "Fontist",
  description: "Fontist brings cross-platform font management to the command line for Windows, Linux, and macOS. Free and open source.",
      ...
      "/guide/": [
        {
          ...
          items: [
            ...
            {text:"Create a new Fontist Formula", link: "https://fontist.org/formulas/"} // TODO: Put formulas webiste "Create formula" guide here
          ]
        },
        {
          text: "API",
